...
$CONFIG = [
    ...
    "RANDOM_KEY" => '5IeojBARImWM203Q', // Random key for encryption
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-yellow",
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-yellow navbar-dark border-bottom-0",
    ...
    "UPLOAD_HREF_PATH" => "uploads/", // Upload file href path (URL for download)
    ...
    "IMPORT_MAX_EXECUTION_TIME" => 6000, // Import max execution time
