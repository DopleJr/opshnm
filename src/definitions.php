...
return [
    ...
    "active_stock" => \DI\create(ActiveStock::class),
    "stock_count_monitor" => \DI\create(StockCountMonitor::class),
    "putaway_staging" => \DI\create(PutawayStaging::class),
    "putaway_staging2" => \DI\create(PutawayStaging2::class),
    "putaway_staging3" => \DI\create(PutawayStaging3::class),
    "putaway_staging4" => \DI\create(PutawayStaging4::class),
    "putaway_staging5" => \DI\create(PutawayStaging5::class),
    "putaway_staging6" => \DI\create(PutawayStaging6::class),
    "putaway_staging7" => \DI\create(PutawayStaging7::class),
    "bin_to_bin" => \DI\create(BinToBin::class),
    "putaway_opening" => \DI\create(PutawayOpening::class),
    "vas_validation" => \DI\create(VasValidation::class),
    "checking_vas" => \DI\create(CheckingVas::class),
    "box_picking_online" => \DI\create(BoxPickingOnline::class),
    "inbound_excess" => \DI\create(InboundExcess::class),
