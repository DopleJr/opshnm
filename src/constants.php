...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "opsmezzanineupload"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{82E0F641-A651-4BB1-8010-BEBF3749166D}"); // Project ID
