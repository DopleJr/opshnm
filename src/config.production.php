...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "password" => "magnum2122", "dbname" => "opsmezzanine"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "rS3uOmtuc30MJJdR", // API Secret Key
        ...
        "EXPIRE_TIME" => 6000 // API expire time
    ]
];
