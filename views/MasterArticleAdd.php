...
// Page object
$MasterArticleAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { master_article: currentTable } });
var currentForm, currentPageID;
var fmaster_articleadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fmaster_articleadd = new ew.Form("fmaster_articleadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fmaster_articleadd;

    // Add fields
    var fields = currentTable.fields;
    fmaster_articleadd.addFields([
    ...
    // Form_CustomValidate
    fmaster_articleadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmaster_articleadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fmaster_articleadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fmaster_articleadd" id="fmaster_articleadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
