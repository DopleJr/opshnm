...
// Page object
$OutboundSummary = &$Page;
?>
<?php if (!$Page->isExport() && !$Page->DrillDown && !$DashboardReport) { ?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { Outbound: currentTable } });
var currentForm, currentPageID;
var fOutboundsrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object for search
    fOutboundsrch = new ew.Form("fOutboundsrch", "summary");
    currentSearchForm = fOutboundsrch;
    currentPageID = ew.PAGE_ID = "summary";

    // Add fields
    var fields = currentTable.fields;
    fOutboundsrch.addFields([
    ...
    // Validate form
    fOutboundsrch.validate = function () {
    ...
    // Form_CustomValidate
    fOutboundsrch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fOutboundsrch.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fOutboundsrch.lists.id = <?= $Page->id->toClientList($Page) ?>;
    fOutboundsrch.lists.box_id = <?= $Page->box_id->toClientList($Page) ?>;
    fOutboundsrch.lists.date_delivery = <?= $Page->date_delivery->toClientList($Page) ?>;
    fOutboundsrch.lists.box_type = <?= $Page->box_type->toClientList($Page) ?>;
    fOutboundsrch.lists.check_by = <?= $Page->check_by->toClientList($Page) ?>;
    fOutboundsrch.lists.quantity = <?= $Page->quantity->toClientList($Page) ?>;
    fOutboundsrch.lists.concept = <?= $Page->concept->toClientList($Page) ?>;
    fOutboundsrch.lists.store_name = <?= $Page->store_name->toClientList($Page) ?>;
    fOutboundsrch.lists.remark = <?= $Page->remark->toClientList($Page) ?>;
    fOutboundsrch.lists.no_delivery = <?= $Page->no_delivery->toClientList($Page) ?>;
    fOutboundsrch.lists.truck_type = <?= $Page->truck_type->toClientList($Page) ?>;
    fOutboundsrch.lists.seal_no = <?= $Page->seal_no->toClientList($Page) ?>;
    fOutboundsrch.lists.truck_plate = <?= $Page->truck_plate->toClientList($Page) ?>;
    fOutboundsrch.lists.transporter = <?= $Page->transporter->toClientList($Page) ?>;
    fOutboundsrch.lists.no_hp = <?= $Page->no_hp->toClientList($Page) ?>;
    fOutboundsrch.lists.checker = <?= $Page->checker->toClientList($Page) ?>;
    fOutboundsrch.lists.admin = <?= $Page->admin->toClientList($Page) ?>;
    fOutboundsrch.lists.remarks_box = <?= $Page->remarks_box->toClientList($Page) ?>;
    fOutboundsrch.lists.date_created = <?= $Page->date_created->toClientList($Page) ?>;
    fOutboundsrch.lists.date_updated = <?= $Page->date_updated->toClientList($Page) ?>;

    // Filters
    fOutboundsrch.filterList = <?= $Page->getFilterList() ?>;
    loadjs.done("fOutboundsrch");
});
</script>
<script>
...
<form name="fOutboundsrch" id="fOutboundsrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
<div id="fOutboundsrch_search_panel" class="mb-2 mb-sm-0 <?= $Page->SearchPanelClass ?>"><!-- .ew-search-panel -->
<input type="hidden" name="cmd" value="search">
<input type="hidden" name="t" value="Outbound">
...
?>
    <div id="xs_id" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->id->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_id"
            data-table="Outbound"
            data-field="x_id"
        ...
        <script>
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_id",
                selectId: "fOutboundsrch_x_id",
                ajax: { id: "x_id", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.id.filterOptions);
...
?>
    <div id="xs_box_id" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->box_id->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_box_id"
            data-table="Outbound"
            data-field="x_box_id"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_box_id",
                selectId: "fOutboundsrch_x_box_id",
                ajax: { id: "x_box_id", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.box_id.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_date_delivery" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->date_delivery->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_date_delivery"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_date_delivery",
                selectId: "fOutboundsrch_x_date_delivery",
                ajax: { id: "x_date_delivery", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.date_delivery.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_box_type" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->box_type->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_box_type"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_box_type",
                selectId: "fOutboundsrch_x_box_type",
                ajax: { id: "x_box_type", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.box_type.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_check_by" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->check_by->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_check_by"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_check_by",
                selectId: "fOutboundsrch_x_check_by",
                ajax: { id: "x_check_by", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.check_by.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_quantity" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->quantity->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_quantity"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_quantity",
                selectId: "fOutboundsrch_x_quantity",
                ajax: { id: "x_quantity", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.quantity.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_concept" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->concept->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_concept"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_concept",
                selectId: "fOutboundsrch_x_concept",
                ajax: { id: "x_concept", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.concept.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_store_name" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->store_name->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_store_name"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_store_name",
                selectId: "fOutboundsrch_x_store_name",
                ajax: { id: "x_store_name", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.store_name.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_remark" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->remark->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_remark"
            data-table="Outbound"
            data-field="x_remark"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_remark",
                selectId: "fOutboundsrch_x_remark",
                ajax: { id: "x_remark", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.remark.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_no_delivery" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->no_delivery->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_no_delivery"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_no_delivery",
                selectId: "fOutboundsrch_x_no_delivery",
                ajax: { id: "x_no_delivery", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.no_delivery.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_truck_type" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->truck_type->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_truck_type"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_truck_type",
                selectId: "fOutboundsrch_x_truck_type",
                ajax: { id: "x_truck_type", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.truck_type.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_seal_no" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->seal_no->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_seal_no"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_seal_no",
                selectId: "fOutboundsrch_x_seal_no",
                ajax: { id: "x_seal_no", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.seal_no.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_truck_plate" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->truck_plate->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_truck_plate"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_truck_plate",
                selectId: "fOutboundsrch_x_truck_plate",
                ajax: { id: "x_truck_plate", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.truck_plate.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_transporter" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->transporter->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_transporter"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_transporter",
                selectId: "fOutboundsrch_x_transporter",
                ajax: { id: "x_transporter", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.transporter.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_no_hp" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->no_hp->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_no_hp"
            data-table="Outbound"
            data-field="x_no_hp"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_no_hp",
                selectId: "fOutboundsrch_x_no_hp",
                ajax: { id: "x_no_hp", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.no_hp.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_checker" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->checker->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_checker"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_checker",
                selectId: "fOutboundsrch_x_checker",
                ajax: { id: "x_checker", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.checker.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_admin" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->admin->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_admin"
            data-table="Outbound"
            data-field="x_admin"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_admin",
                selectId: "fOutboundsrch_x_admin",
                ajax: { id: "x_admin", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.admin.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_remarks_box" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->remarks_box->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_remarks_box"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_remarks_box",
                selectId: "fOutboundsrch_x_remarks_box",
                ajax: { id: "x_remarks_box", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.remarks_box.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_date_created" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->date_created->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_date_created"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_date_created",
                selectId: "fOutboundsrch_x_date_created",
                ajax: { id: "x_date_created", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.date_created.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_date_updated" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->date_updated->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fOutboundsrch_x_date_updated"
            data-table="Outbound"
        ...
        loadjs.ready("fOutboundsrch", function() {
            var options = {
                name: "x_date_updated",
                selectId: "fOutboundsrch_x_date_updated",
                ajax: { id: "x_date_updated", form: "fOutboundsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.Outbound.fields.date_updated.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_Outbound" class="<?= ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
<table class="<?= $Page->ReportTableClass ?>">
<thead>
	<!-- Table header -->
    <tr class="ew-table-header">
<?php if ($Page->id->Visible) { ?>
    <th data-name="id" class="<?= $Page->id->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_id"><?= $Page->renderFieldHeader($Page->id) ?></div></th>
<?php } ?>
<?php if ($Page->box_id->Visible) { ?>
    <th data-name="box_id" class="<?= $Page->box_id->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_box_id"><?= $Page->renderFieldHeader($Page->box_id) ?></div></th>
<?php } ?>
<?php if ($Page->date_delivery->Visible) { ?>
    <th data-name="date_delivery" class="<?= $Page->date_delivery->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_date_delivery"><?= $Page->renderFieldHeader($Page->date_delivery) ?></div></th>
<?php } ?>
<?php if ($Page->box_type->Visible) { ?>
    <th data-name="box_type" class="<?= $Page->box_type->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_box_type"><?= $Page->renderFieldHeader($Page->box_type) ?></div></th>
<?php } ?>
<?php if ($Page->check_by->Visible) { ?>
    <th data-name="check_by" class="<?= $Page->check_by->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_check_by"><?= $Page->renderFieldHeader($Page->check_by) ?></div></th>
<?php } ?>
<?php if ($Page->quantity->Visible) { ?>
    <th data-name="quantity" class="<?= $Page->quantity->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_quantity"><?= $Page->renderFieldHeader($Page->quantity) ?></div></th>
<?php } ?>
<?php if ($Page->concept->Visible) { ?>
    <th data-name="concept" class="<?= $Page->concept->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_concept"><?= $Page->renderFieldHeader($Page->concept) ?></div></th>
<?php } ?>
<?php if ($Page->store_name->Visible) { ?>
    <th data-name="store_name" class="<?= $Page->store_name->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_store_name"><?= $Page->renderFieldHeader($Page->store_name) ?></div></th>
<?php } ?>
<?php if ($Page->remark->Visible) { ?>
    <th data-name="remark" class="<?= $Page->remark->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_remark"><?= $Page->renderFieldHeader($Page->remark) ?></div></th>
<?php } ?>
<?php if ($Page->no_delivery->Visible) { ?>
    <th data-name="no_delivery" class="<?= $Page->no_delivery->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_no_delivery"><?= $Page->renderFieldHeader($Page->no_delivery) ?></div></th>
<?php } ?>
<?php if ($Page->truck_type->Visible) { ?>
    <th data-name="truck_type" class="<?= $Page->truck_type->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_truck_type"><?= $Page->renderFieldHeader($Page->truck_type) ?></div></th>
<?php } ?>
<?php if ($Page->seal_no->Visible) { ?>
    <th data-name="seal_no" class="<?= $Page->seal_no->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_seal_no"><?= $Page->renderFieldHeader($Page->seal_no) ?></div></th>
<?php } ?>
<?php if ($Page->truck_plate->Visible) { ?>
    <th data-name="truck_plate" class="<?= $Page->truck_plate->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_truck_plate"><?= $Page->renderFieldHeader($Page->truck_plate) ?></div></th>
<?php } ?>
<?php if ($Page->transporter->Visible) { ?>
    <th data-name="transporter" class="<?= $Page->transporter->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_transporter"><?= $Page->renderFieldHeader($Page->transporter) ?></div></th>
<?php } ?>
<?php if ($Page->no_hp->Visible) { ?>
    <th data-name="no_hp" class="<?= $Page->no_hp->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_no_hp"><?= $Page->renderFieldHeader($Page->no_hp) ?></div></th>
<?php } ?>
<?php if ($Page->checker->Visible) { ?>
    <th data-name="checker" class="<?= $Page->checker->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_checker"><?= $Page->renderFieldHeader($Page->checker) ?></div></th>
<?php } ?>
<?php if ($Page->admin->Visible) { ?>
    <th data-name="admin" class="<?= $Page->admin->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_admin"><?= $Page->renderFieldHeader($Page->admin) ?></div></th>
<?php } ?>
<?php if ($Page->remarks_box->Visible) { ?>
    <th data-name="remarks_box" class="<?= $Page->remarks_box->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_remarks_box"><?= $Page->renderFieldHeader($Page->remarks_box) ?></div></th>
<?php } ?>
<?php if ($Page->date_created->Visible) { ?>
    <th data-name="date_created" class="<?= $Page->date_created->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_date_created"><?= $Page->renderFieldHeader($Page->date_created) ?></div></th>
<?php } ?>
<?php if ($Page->date_updated->Visible) { ?>
    <th data-name="date_updated" class="<?= $Page->date_updated->headerCellClass() ?>" style="white-space: nowrap;"><div class="Outbound_date_updated"><?= $Page->renderFieldHeader($Page->date_updated) ?></div></th>
<?php } ?>
<?php if ($Page->Week->Visible) { ?>
    <th data-name="Week" class="<?= $Page->Week->headerCellClass() ?>"><div class="Outbound_Week"><?= $Page->renderFieldHeader($Page->Week) ?></div></th>
<?php } ?>
<?php if ($Page->store_code->Visible) { ?>
    <th data-name="store_code" class="<?= $Page->store_code->headerCellClass() ?>"><div class="Outbound_store_code"><?= $Page->renderFieldHeader($Page->store_code) ?></div></th>
<?php } ?>
    </tr>
</thead>
<tbody>
...
<?php } ?>
<?php if ($Page->Week->Visible) { ?>
        <td data-field="Week"<?= $Page->Week->cellAttributes() ?>>
<span<?= $Page->Week->viewAttributes() ?>>
<?= $Page->Week->getViewValue() ?></span>
</td>
<?php } ?>
<?php if ($Page->store_code->Visible) { ?>
        <td data-field="store_code"<?= $Page->store_code->cellAttributes() ?>>
...
if (!$DashboardReport) {
    ...
    if (($Page->isExport("print") || $Page->isExport("pdf") || $Page->isExport("email") || $Page->isExport("excel") && Config("USE_PHPEXCEL") || $Page->isExport("word") && Config("USE_PHPWORD")) && $Page->ExportChartPageBreak) {
        ...
        $Page->DeliveryTypeOrder->PageBreakType = "before"; // Page break type
        $Page->DeliveryTypeOrder->PageBreak = $Page->ExportChartPageBreak;
        $Page->DeliveryTypeOrder->PageBreakContent = $Page->PageBreakContent;
    }

    // Set up chart drilldown
    $Page->DeliveryTypeOrder->DrillDownInPanel = $Page->DrillDownInPanel;
    $Page->DeliveryTypeOrder->render("ew-chart-bottom");
}
?>
<?php if (!$DashboardReport && !$Page->isExport("email") && !$Page->DrillDown && $Page->DeliveryTypeOrder->hasData()) { ?>
