...
// Page object
$BlankCountSheetAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { blank_count_sheet: currentTable } });
var currentForm, currentPageID;
var fblank_count_sheetadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fblank_count_sheetadd = new ew.Form("fblank_count_sheetadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fblank_count_sheetadd;

    // Add fields
    var fields = currentTable.fields;
    fblank_count_sheetadd.addFields([
    ...
    // Form_CustomValidate
    fblank_count_sheetadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fblank_count_sheetadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fblank_count_sheetadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fblank_count_sheetadd" id="fblank_count_sheetadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->location->Visible) { // location ?>
    <div id="r_location"<?= $Page->location->rowAttributes() ?>>
        <label id="elh_blank_count_sheet_location" for="x_location" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_blank_count_sheet_location"><?= $Page->location->caption() ?><?= $Page->location->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->location->cellAttributes() ?>>
<template id="tpx_blank_count_sheet_location"><span id="el_blank_count_sheet_location">
...
<?php if ($Page->ctn->Visible) { // ctn ?>
    <div id="r_ctn"<?= $Page->ctn->rowAttributes() ?>>
        <label id="elh_blank_count_sheet_ctn" for="x_ctn" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_blank_count_sheet_ctn"><?= $Page->ctn->caption() ?><?= $Page->ctn->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->ctn->cellAttributes() ?>>
<template id="tpx_blank_count_sheet_ctn"><span id="el_blank_count_sheet_ctn">
...
<?php if ($Page->scan->Visible) { // scan ?>
    <div id="r_scan"<?= $Page->scan->rowAttributes() ?>>
        <label id="elh_blank_count_sheet_scan" for="x_scan" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_blank_count_sheet_scan"><?= $Page->scan->caption() ?><?= $Page->scan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->scan->cellAttributes() ?>>
<template id="tpx_blank_count_sheet_scan"><span id="el_blank_count_sheet_scan">
<input type="<?= $Page->scan->getInputTextType() ?>" name="x_scan" id="x_scan" data-table="blank_count_sheet" data-field="x_scan" value="<?= $Page->scan->EditValue ?>" placeholder="<?= HtmlEncode($Page->scan->getPlaceHolder()) ?>"<?= $Page->scan->editAttributes() ?> aria-describedby="x_scan_help">
...
<?php if ($Page->gtin->Visible) { // gtin ?>
    <div id="r_gtin"<?= $Page->gtin->rowAttributes() ?>>
        <label id="elh_blank_count_sheet_gtin" for="x_gtin" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_blank_count_sheet_gtin"><?= $Page->gtin->caption() ?><?= $Page->gtin->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->gtin->cellAttributes() ?>>
<template id="tpx_blank_count_sheet_gtin"><span id="el_blank_count_sheet_gtin">
<input type="<?= $Page->gtin->getInputTextType() ?>" name="x_gtin" id="x_gtin" data-table="blank_count_sheet" data-field="x_gtin" value="<?= $Page->gtin->EditValue ?>" placeholder="<?= HtmlEncode($Page->gtin->getPlaceHolder()) ?>"<?= $Page->gtin->editAttributes() ?> aria-describedby="x_gtin_help">
...
<?php if ($Page->gtin2->Visible) { // gtin2 ?>
    <div id="r_gtin2"<?= $Page->gtin2->rowAttributes() ?>>
        <label id="elh_blank_count_sheet_gtin2" for="x_gtin2" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_blank_count_sheet_gtin2"><?= $Page->gtin2->caption() ?><?= $Page->gtin2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->gtin2->cellAttributes() ?>>
<template id="tpx_blank_count_sheet_gtin2"><span id="el_blank_count_sheet_gtin2">
<input type="<?= $Page->gtin2->getInputTextType() ?>" name="x_gtin2" id="x_gtin2" data-table="blank_count_sheet" data-field="x_gtin2" value="<?= $Page->gtin2->EditValue ?>" placeholder="<?= HtmlEncode($Page->gtin2->getPlaceHolder()) ?>"<?= $Page->gtin2->editAttributes() ?> aria-describedby="x_gtin2_help">
...
<?php if ($Page->gtin3->Visible) { // gtin3 ?>
    <div id="r_gtin3"<?= $Page->gtin3->rowAttributes() ?>>
        <label id="elh_blank_count_sheet_gtin3" for="x_gtin3" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_blank_count_sheet_gtin3"><?= $Page->gtin3->caption() ?><?= $Page->gtin3->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->gtin3->cellAttributes() ?>>
<template id="tpx_blank_count_sheet_gtin3"><span id="el_blank_count_sheet_gtin3">
<input type="<?= $Page->gtin3->getInputTextType() ?>" name="x_gtin3" id="x_gtin3" data-table="blank_count_sheet" data-field="x_gtin3" value="<?= $Page->gtin3->EditValue ?>" placeholder="<?= HtmlEncode($Page->gtin3->getPlaceHolder()) ?>"<?= $Page->gtin3->editAttributes() ?> aria-describedby="x_gtin3_help">
...
<?php if ($Page->article->Visible) { // article ?>
    <div id="r_article"<?= $Page->article->rowAttributes() ?>>
        <label id="elh_blank_count_sheet_article" for="x_article" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_blank_count_sheet_article"><?= $Page->article->caption() ?><?= $Page->article->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->article->cellAttributes() ?>>
<template id="tpx_blank_count_sheet_article"><span id="el_blank_count_sheet_article">
...
<div id="tpd_blank_count_sheetadd" class="ew-custom-template"></div>
<template id="tpm_blank_count_sheetadd">
<div id="ct_BlankCountSheetAdd"><script type="text/javascript">
...
<style>
    ...
    <div id="r_su" class="mb-3 row" >
        ...
        <div class="col-sm-10"><slot class="ew-slot" name="tpx_blank_count_sheet_ctn"></slot></div>
    </div>
    <div id="r_scan" class="mb-3 row">
        <label for="x_scan" class="col-sm-2 col-form-label"><?= $Page->scan->caption() ?></label>
        <div class="col-sm-10"><slot class="ew-slot" name="tpx_blank_count_sheet_scan"></slot></div>
    </div>
    <div id="r_scan" class="mb-3 row" hidden>
        <label for="x_gtin" class="col-sm-2 col-form-label"><?= $Page->gtin->caption() ?></label>
        <div class="col-sm-10"><slot class="ew-slot" name="tpx_blank_count_sheet_gtin"></slot></div>
    </div>
    <div id="r_scan" class="mb-3 row" hidden>
        <label for="x_gtin2" class="col-sm-2 col-form-label"><?= $Page->gtin2->caption() ?></label>
        <div class="col-sm-10"><slot class="ew-slot" name="tpx_blank_count_sheet_gtin2"></slot></div>
    </div>
    <div id="r_scan" class="mb-3 row" hidden>
        <label for="x_gtin3" class="col-sm-2 col-form-label"><?= $Page->gtin3->caption() ?></label>
        <div class="col-sm-10"><slot class="ew-slot" name="tpx_blank_count_sheet_gtin3"></slot></div>
    </div>
    <div id="r_article" class="mb-3 row">
        <label for="x_article" class="col-sm-2 col-form-label"><?= $Page->article->caption() ?></label>
        <div class="col-sm-10"><slot class="ew-slot" name="tpx_blank_count_sheet_article"></slot></div>
    </div>
</div>
</template>
<?php if (!$Page->IsModal) { ?>
...
loadjs.ready(ew.applyTemplateId, function() {
    ...
    ew.applyTemplate("tpd_blank_count_sheetadd", "tpm_blank_count_sheetadd", "blank_count_sheetadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
