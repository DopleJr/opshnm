...
var foss_manual_onlinelist;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    foss_manual_onlinelist = new ew.Form("foss_manual_onlinelist", "list");
    currentPageID = ew.PAGE_ID = "list";
    currentForm = foss_manual_onlinelist;
    foss_manual_onlinelist.formKeyCountName = "<?= $Page->FormKeyCountName ?>";
    ...
    foss_manual_onlinelist.lists.ctn_no = <?= $Page->ctn_no->toClientList($Page) ?>;
    foss_manual_onlinelist.lists.checker = <?= $Page->checker->toClientList($Page) ?>;
    foss_manual_onlinelist.lists.shift = <?= $Page->shift->toClientList($Page) ?>;
    loadjs.done("foss_manual_onlinelist");
});
var foss_manual_onlinesrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object for search
    foss_manual_onlinesrch = new ew.Form("foss_manual_onlinesrch", "list");
    currentSearchForm = foss_manual_onlinesrch;
    ...
    // Validate form
    foss_manual_onlinesrch.validate = function () {
    ...
    // Form_CustomValidate
    foss_manual_onlinesrch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    foss_manual_onlinesrch.validateRequired = ew.CLIENT_VALIDATE;
    ...
    foss_manual_onlinesrch.lists.ctn_no = <?= $Page->ctn_no->toClientList($Page) ?>;
    foss_manual_onlinesrch.lists.checker = <?= $Page->checker->toClientList($Page) ?>;
    foss_manual_onlinesrch.lists.shift = <?= $Page->shift->toClientList($Page) ?>;

    // Filters
    foss_manual_onlinesrch.filterList = <?= $Page->getFilterList() ?>;
    loadjs.done("foss_manual_onlinesrch");
});
</script>
<script>
...
<form name="foss_manual_onlinesrch" id="foss_manual_onlinesrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
<div id="foss_manual_onlinesrch_search_panel" class="mb-2 mb-sm-0 <?= $Page->SearchPanelClass ?>"><!-- .ew-search-panel -->
...
?>
    <div id="xs_date" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->date->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="foss_manual_onlinesrch_x_date"
        ...
        loadjs.ready("foss_manual_onlinesrch", function() {
            var options = {
                name: "x_date",
                selectId: "foss_manual_onlinesrch_x_date",
...
?>
    <div id="xs_order_no" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->order_no->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="foss_manual_onlinesrch_x_order_no"
            data-table="oss_manual_online"
        ...
        loadjs.ready("foss_manual_onlinesrch", function() {
            var options = {
                name: "x_order_no",
                selectId: "foss_manual_onlinesrch_x_order_no",
                ajax: { id: "x_order_no", form: "foss_manual_onlinesrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.oss_manual_online.fields.order_no.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_shipment" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->shipment->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="foss_manual_onlinesrch_x_shipment"
            data-table="oss_manual_online"
        ...
        loadjs.ready("foss_manual_onlinesrch", function() {
            var options = {
                name: "x_shipment",
                selectId: "foss_manual_onlinesrch_x_shipment",
                ajax: { id: "x_shipment", form: "foss_manual_onlinesrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.oss_manual_online.fields.shipment.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_pallet_no" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->pallet_no->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="foss_manual_onlinesrch_x_pallet_no"
            data-table="oss_manual_online"
        ...
        loadjs.ready("foss_manual_onlinesrch", function() {
            var options = {
                name: "x_pallet_no",
                selectId: "foss_manual_onlinesrch_x_pallet_no",
...
?>
    <div id="xs_idw" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->idw->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="foss_manual_onlinesrch_x_idw"
            data-table="oss_manual_online"
            data-field="x_idw"
        ...
        loadjs.ready("foss_manual_onlinesrch", function() {
            var options = {
                name: "x_idw",
                selectId: "foss_manual_onlinesrch_x_idw",
                ajax: { id: "x_idw", form: "foss_manual_onlinesrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.oss_manual_online.fields.idw.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_item_in_ctn" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->item_in_ctn->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="foss_manual_onlinesrch_x_item_in_ctn"
            data-table="oss_manual_online"
        ...
        loadjs.ready("foss_manual_onlinesrch", function() {
            var options = {
                name: "x_item_in_ctn",
                selectId: "foss_manual_onlinesrch_x_item_in_ctn",
                ajax: { id: "x_item_in_ctn", form: "foss_manual_onlinesrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.oss_manual_online.fields.item_in_ctn.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_no_of_ctn" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->no_of_ctn->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="foss_manual_onlinesrch_x_no_of_ctn"
            data-table="oss_manual_online"
        ...
        loadjs.ready("foss_manual_onlinesrch", function() {
            var options = {
                name: "x_no_of_ctn",
                selectId: "foss_manual_onlinesrch_x_no_of_ctn",
                ajax: { id: "x_no_of_ctn", form: "foss_manual_onlinesrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.oss_manual_online.fields.no_of_ctn.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_ctn_no" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->ctn_no->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="foss_manual_onlinesrch_x_ctn_no"
            data-table="oss_manual_online"
            data-field="x_ctn_no"
        ...
        loadjs.ready("foss_manual_onlinesrch", function() {
            var options = {
                name: "x_ctn_no",
                selectId: "foss_manual_onlinesrch_x_ctn_no",
                ajax: { id: "x_ctn_no", form: "foss_manual_onlinesrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.oss_manual_online.fields.ctn_no.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_checker" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->checker->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="foss_manual_onlinesrch_x_checker"
            data-table="oss_manual_online"
        ...
        loadjs.ready("foss_manual_onlinesrch", function() {
            var options = {
                name: "x_checker",
                selectId: "foss_manual_onlinesrch_x_checker",
                ajax: { id: "x_checker", form: "foss_manual_onlinesrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.oss_manual_online.fields.checker.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_shift" class="col-sm-auto d-sm-flex mb-3 px-0 pe-sm-2<?= $Page->shift->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="foss_manual_onlinesrch_x_shift"
            data-table="oss_manual_online"
            data-field="x_shift"
        ...
        loadjs.ready("foss_manual_onlinesrch", function() {
            var options = {
                name: "x_shift",
                selectId: "foss_manual_onlinesrch_x_shift",
                ajax: { id: "x_shift", form: "foss_manual_onlinesrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.oss_manual_online.fields.shift.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
    ...
    <div class="col-sm-auto px-0 pe-sm-2">
        <div class="ew-basic-search input-group">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <button type="button" class="dropdown-item<?= $Page->BasicSearch->getType() == "" ? " active" : "" ?>" form="foss_manual_onlinesrch" data-ew-action="search-type"><?= $Language->phrase("QuickSearchAuto") ?></button>
                <button type="button" class="dropdown-item<?= $Page->BasicSearch->getType() == "=" ? " active" : "" ?>" form="foss_manual_onlinesrch" data-ew-action="search-type" data-search-type="="><?= $Language->phrase("QuickSearchExact") ?></button>
                <button type="button" class="dropdown-item<?= $Page->BasicSearch->getType() == "AND" ? " active" : "" ?>" form="foss_manual_onlinesrch" data-ew-action="search-type" data-search-type="AND"><?= $Language->phrase("QuickSearchAll") ?></button>
                <button type="button" class="dropdown-item<?= $Page->BasicSearch->getType() == "OR" ? " active" : "" ?>" form="foss_manual_onlinesrch" data-ew-action="search-type" data-search-type="OR"><?= $Language->phrase("QuickSearchAny") ?></button>
            </div>
        </div>
    </div>
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> oss_manual_online">
<?php if (!$Page->isExport()) { ?>
...
<?php } ?>
<form name="foss_manual_onlinelist" id="foss_manual_onlinelist" class="ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="oss_manual_online">
<div id="gmp_oss_manual_online" class="<?= ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit()) { ?>
<table id="tbl_oss_manual_onlinelist" class="table table-bordered table-hover table-sm ew-table"><!-- .ew-table -->
<thead>
...
<?php } ?>
<?php if ($Page->shipment->Visible) { // shipment ?>
        <th data-name="shipment" class="<?= $Page->shipment->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_oss_manual_online_shipment" class="oss_manual_online_shipment"><?= $Page->renderFieldHeader($Page->shipment) ?></div></th>
<?php } ?>
<?php if ($Page->pallet_no->Visible) { // pallet_no ?>
...
<?php } ?>
<?php if ($Page->item_in_ctn->Visible) { // item_in_ctn ?>
        <th data-name="item_in_ctn" class="<?= $Page->item_in_ctn->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_oss_manual_online_item_in_ctn" class="oss_manual_online_item_in_ctn"><?= $Page->renderFieldHeader($Page->item_in_ctn) ?></div></th>
<?php } ?>
<?php if ($Page->no_of_ctn->Visible) { // no_of_ctn ?>
        <th data-name="no_of_ctn" class="<?= $Page->no_of_ctn->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_oss_manual_online_no_of_ctn" class="oss_manual_online_no_of_ctn"><?= $Page->renderFieldHeader($Page->no_of_ctn) ?></div></th>
<?php } ?>
<?php if ($Page->ctn_no->Visible) { // ctn_no ?>
        <th data-name="ctn_no" class="<?= $Page->ctn_no->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_oss_manual_online_ctn_no" class="oss_manual_online_ctn_no"><?= $Page->renderFieldHeader($Page->ctn_no) ?></div></th>
<?php } ?>
<?php if ($Page->checker->Visible) { // checker ?>
        <th data-name="checker" class="<?= $Page->checker->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_oss_manual_online_checker" class="oss_manual_online_checker"><?= $Page->renderFieldHeader($Page->checker) ?></div></th>
<?php } ?>
<?php if ($Page->shift->Visible) { // shift ?>
        <th data-name="shift" class="<?= $Page->shift->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_oss_manual_online_shift" class="oss_manual_online_shift"><?= $Page->renderFieldHeader($Page->shift) ?></div></th>
<?php } ?>
<?php
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge([
            ...
            "id" => "r" . $Page->RowCount . "_oss_manual_online",
...
<span id="el<?= $Page->RowCount ?>_oss_manual_online_shipment" class="el_oss_manual_online_shipment">
...
<span id="el<?= $Page->RowCount ?>_oss_manual_online_idw" class="el_oss_manual_online_idw">
...
<span id="el<?= $Page->RowCount ?>_oss_manual_online_item_in_ctn" class="el_oss_manual_online_item_in_ctn">
...
<span id="el<?= $Page->RowCount ?>_oss_manual_online_no_of_ctn" class="el_oss_manual_online_no_of_ctn">
...
<span id="el<?= $Page->RowCount ?>_oss_manual_online_ctn_no" class="el_oss_manual_online_ctn_no">
...
<span id="el<?= $Page->RowCount ?>_oss_manual_online_checker" class="el_oss_manual_online_checker">
...
<span id="el<?= $Page->RowCount ?>_oss_manual_online_shift" class="el_oss_manual_online_shift">
