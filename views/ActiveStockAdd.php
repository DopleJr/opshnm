...
var factive_stockadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    factive_stockadd = new ew.Form("factive_stockadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = factive_stockadd;

    // Add fields
    var fields = currentTable.fields;
    factive_stockadd.addFields([
        ["aisle", [fields.aisle.visible && fields.aisle.required ? ew.Validators.required(fields.aisle.caption) : null], fields.aisle.isInvalid],
        ["active_bin", [fields.active_bin.visible && fields.active_bin.required ? ew.Validators.required(fields.active_bin.caption) : null], fields.active_bin.isInvalid],
        ["active_stock", [fields.active_stock.visible && fields.active_stock.required ? ew.Validators.required(fields.active_stock.caption) : null], fields.active_stock.isInvalid]
    ]);

    // Form_CustomValidate
    factive_stockadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    factive_stockadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("factive_stockadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="factive_stockadd" id="factive_stockadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
