...
// Page object
$FindingShortpick2Add = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { finding_shortpick2: currentTable } });
var currentForm, currentPageID;
var ffinding_shortpick2add;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    ffinding_shortpick2add = new ew.Form("ffinding_shortpick2add", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = ffinding_shortpick2add;

    // Add fields
    var fields = currentTable.fields;
    ffinding_shortpick2add.addFields([
    ...
    // Form_CustomValidate
    ffinding_shortpick2add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ffinding_shortpick2add.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("ffinding_shortpick2add");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="ffinding_shortpick2add" id="ffinding_shortpick2add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["ffinding_shortpick2add", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ffinding_shortpick2add", "x_date_shortpick", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["ffinding_shortpick2add", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ffinding_shortpick2add", "x_date_upload", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["ffinding_shortpick2add", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ffinding_shortpick2add", "x_date_picking", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["ffinding_shortpick2add", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ffinding_shortpick2add", "x_time_picking", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
