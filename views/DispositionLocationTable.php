...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_disposition_location_id" class="disposition_location_id"><?= $Page->renderFieldHeader($Page->id) ?></div></th>
<?php } ?>
<?php if ($Page->note->Visible) { // note ?>
        <th data-name="note" class="<?= $Page->note->headerCellClass() ?>"><div id="elh_disposition_location_note" class="disposition_location_note"><?= $Page->renderFieldHeader($Page->note) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_disposition_location_id" class="el_disposition_location_id">
...
<span id="el<?= $Page->RowCount ?>_disposition_location_note" class="el_disposition_location_note">
