...
$sideMenu->addMenuItem(482, "mi_check_box", $MenuLanguage->MenuPhrase("482", "MenuText"), $MenuRelativePath . "checkboxlist", 367, "", AllowListMenu('{82E0F641-A651-4BB1-8010-BEBF3749166D}check_box'), false, false, "", "", false, true);
$sideMenu->addMenuItem(481, "mi_productivity_online", $MenuLanguage->MenuPhrase("481", "MenuText"), $MenuRelativePath . "productivityonlinelist", 367, "", AllowListMenu('{82E0F641-A651-4BB1-8010-BEBF3749166D}productivity_online'), false, false, "", "", false, true);
...
$sideMenu->addMenuItem(483, "mi_audit_picking_online", $MenuLanguage->MenuPhrase("483", "MenuText"), $MenuRelativePath . "auditpickingonlinelist", 367, "", AllowListMenu('{82E0F641-A651-4BB1-8010-BEBF3749166D}audit_picking_online'), false, false, "", "", false, true);
