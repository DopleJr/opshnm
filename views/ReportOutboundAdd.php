...
// Page object
$ReportOutboundAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { report_outbound: currentTable } });
var currentForm, currentPageID;
var freport_outboundadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    freport_outboundadd = new ew.Form("freport_outboundadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = freport_outboundadd;

    // Add fields
    var fields = currentTable.fields;
    freport_outboundadd.addFields([
    ...
    // Form_CustomValidate
    freport_outboundadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    freport_outboundadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("freport_outboundadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="freport_outboundadd" id="freport_outboundadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["freport_outboundadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("freport_outboundadd", "x_date_delivery", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["freport_outboundadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("freport_outboundadd", "x_date_created", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
