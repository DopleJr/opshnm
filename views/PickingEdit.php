...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpickingedit = new ew.Form("fpickingedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fpickingedit;

    // Add fields
    var fields = currentTable.fields;
    fpickingedit.addFields([
    ...
    // Form_CustomValidate
    fpickingedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
$Page->showMessage();
?>
<form name="fpickingedit" id="fpickingedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id"<?= $Page->id->rowAttributes() ?>>
        <label id="elh_picking_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->id->cellAttributes() ?>>
<span id="el_picking_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
<input type="hidden" data-table="picking" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
loadjs.ready(["fpickingedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpickingedit", "x_creation_date", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpickingedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpickingedit", "x_gr_date", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpickingedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpickingedit", "x_confirmation_date", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
