...
// Page object
$VasValidationAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { vas_validation: currentTable } });
var currentForm, currentPageID;
var fvas_validationadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fvas_validationadd = new ew.Form("fvas_validationadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fvas_validationadd;

    // Add fields
    var fields = currentTable.fields;
    fvas_validationadd.addFields([
    ...
    // Form_CustomValidate
    fvas_validationadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fvas_validationadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fvas_validationadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fvas_validationadd" id="fvas_validationadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="<?= $Page->order->getInputTextType() ?>" name="x_order" id="x_order" data-table="vas_validation" data-field="x_order" value="<?= $Page->order->EditValue ?>" data-page="1" size="30" maxlength="6" placeholder="<?= HtmlEncode($Page->order->getPlaceHolder()) ?>"<?= $Page->order->editAttributes() ?> aria-describedby="x_order_help">
...
<input type="<?= $Page->po->getInputTextType() ?>" name="x_po" id="x_po" data-table="vas_validation" data-field="x_po" value="<?= $Page->po->EditValue ?>" data-page="1" size="30" maxlength="10" placeholder="<?= HtmlEncode($Page->po->getPlaceHolder()) ?>"<?= $Page->po->editAttributes() ?> aria-describedby="x_po_help">
...
<input type="<?= $Page->sap_art->getInputTextType() ?>" name="x_sap_art" id="x_sap_art" data-table="vas_validation" data-field="x_sap_art" value="<?= $Page->sap_art->EditValue ?>" data-page="1" size="30" maxlength="16" placeholder="<?= HtmlEncode($Page->sap_art->getPlaceHolder()) ?>"<?= $Page->sap_art->editAttributes() ?> aria-describedby="x_sap_art_help">
...
<input type="<?= $Page->sub_index->getInputTextType() ?>" name="x_sub_index" id="x_sub_index" data-table="vas_validation" data-field="x_sub_index" value="<?= $Page->sub_index->EditValue ?>" data-page="1" size="30" maxlength="4" placeholder="<?= HtmlEncode($Page->sub_index->getPlaceHolder()) ?>"<?= $Page->sub_index->editAttributes() ?> aria-describedby="x_sub_index_help">
...
<input type="<?= $Page->concept->getInputTextType() ?>" name="x_concept" id="x_concept" data-table="vas_validation" data-field="x_concept" value="<?= $Page->concept->EditValue ?>" data-page="1" size="30" maxlength="2" placeholder="<?= HtmlEncode($Page->concept->getPlaceHolder()) ?>"<?= $Page->concept->editAttributes() ?> aria-describedby="x_concept_help">
...
<input type="<?= $Page->ctn->getInputTextType() ?>" name="x_ctn" id="x_ctn" data-table="vas_validation" data-field="x_ctn" value="<?= $Page->ctn->EditValue ?>" data-page="1" size="30" placeholder="<?= HtmlEncode($Page->ctn->getPlaceHolder()) ?>"<?= $Page->ctn->editAttributes() ?> aria-describedby="x_ctn_help">
...
<input type="<?= $Page->season2->getInputTextType() ?>" name="x_season2" id="x_season2" data-table="vas_validation" data-field="x_season2" value="<?= $Page->season2->EditValue ?>" data-page="1" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->season2->getPlaceHolder()) ?>"<?= $Page->season2->editAttributes() ?> aria-describedby="x_season2_help">
...
<input type="<?= $Page->qty_oss->getInputTextType() ?>" name="x_qty_oss" id="x_qty_oss" data-table="vas_validation" data-field="x_qty_oss" value="<?= $Page->qty_oss->EditValue ?>" data-page="1" size="30" placeholder="<?= HtmlEncode($Page->qty_oss->getPlaceHolder()) ?>"<?= $Page->qty_oss->editAttributes() ?> aria-describedby="x_qty_oss_help">
...
<input type="<?= $Page->shipment->getInputTextType() ?>" name="x_shipment" id="x_shipment" data-table="vas_validation" data-field="x_shipment" value="<?= $Page->shipment->EditValue ?>" data-page="1" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->shipment->getPlaceHolder()) ?>"<?= $Page->shipment->editAttributes() ?> aria-describedby="x_shipment_help">
...
<input type="<?= $Page->aju->getInputTextType() ?>" name="x_aju" id="x_aju" data-table="vas_validation" data-field="x_aju" value="<?= $Page->aju->EditValue ?>" data-page="1" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->aju->getPlaceHolder()) ?>"<?= $Page->aju->editAttributes() ?> aria-describedby="x_aju_help">
...
<input type="<?= $Page->actual_price->getInputTextType() ?>" name="x_actual_price" id="x_actual_price" data-table="vas_validation" data-field="x_actual_price" value="<?= $Page->actual_price->EditValue ?>" data-page="1" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->actual_price->getPlaceHolder()) ?>"<?= $Page->actual_price->editAttributes() ?> aria-describedby="x_actual_price_help">
...
<input type="<?= $Page->snow->getInputTextType() ?>" name="x_snow" id="x_snow" data-table="vas_validation" data-field="x_snow" value="<?= $Page->snow->EditValue ?>" data-page="1" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->snow->getPlaceHolder()) ?>"<?= $Page->snow->editAttributes() ?> aria-describedby="x_snow_help">
...
<input type="<?= $Page->remarks->getInputTextType() ?>" name="x_remarks" id="x_remarks" data-table="vas_validation" data-field="x_remarks" value="<?= $Page->remarks->EditValue ?>" data-page="1" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->remarks->getPlaceHolder()) ?>"<?= $Page->remarks->editAttributes() ?> aria-describedby="x_remarks_help">
...
<input type="<?= $Page->date_upload->getInputTextType() ?>" name="x_date_upload" id="x_date_upload" data-table="vas_validation" data-field="x_date_upload" value="<?= $Page->date_upload->EditValue ?>" data-page="1" placeholder="<?= HtmlEncode($Page->date_upload->getPlaceHolder()) ?>"<?= $Page->date_upload->editAttributes() ?> aria-describedby="x_date_upload_help">
...
<script>
loadjs.ready(["fvas_validationadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fvas_validationadd", "x_date_upload", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->status->getInputTextType() ?>" name="x_status" id="x_status" data-table="vas_validation" data-field="x_status" value="<?= $Page->status->EditValue ?>" data-page="1" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->status->getPlaceHolder()) ?>"<?= $Page->status->editAttributes() ?> aria-describedby="x_status_help">
