...
<?php if ($Page->user->Visible) { // user ?>
    <tr id="r_user"<?= $Page->user->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_print_label_user"><template id="tpc_print_label_user"><?= $Page->user->caption() ?></template></span></td>
...
<?php if ($Page->date_created->Visible) { // date_created ?>
    <tr id="r_date_created"<?= $Page->date_created->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_print_label_date_created"><template id="tpc_print_label_date_created"><?= $Page->date_created->caption() ?></template></span></td>
...
<?php if ($Page->time_created->Visible) { // time_created ?>
    <tr id="r_time_created"<?= $Page->time_created->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_print_label_time_created"><template id="tpc_print_label_time_created"><?= $Page->time_created->caption() ?></template></span></td>
...
>
  <head>
    ...
    <meta name="Generator" content="Aspose.Cell 22.9.3" />
    ...
    <!--[if gte mso 9
        ...
        <o:DocumentProperties>
          ...
          <o:LastSaved>2022-09-29T11:29:36Z</o:LastSaved>
        </o:DocumentProperties>
      </xml><!
    [endif]-->
    <style>
  ...
  <body link="blue" vlink="purple">
    ...
    >
      ...
      <col
        width="89"
        span="2"
        style="mso-width-source: userset; width: 66.75pt"
      />
          ...
          <a name="Print_Area"
            ><span
              style="
                ...
                font-family: 'Calibri';
              "
              ><slot class="ew-slot" name="tpx_print_label_priority"></slot></span
            ></a
          >
        </td>
        <td
          ...
          "
        >
          <slot class="ew-slot" name="tpx_print_label_box_id"></slot>
        </td>
        <td
          rowspan="2"
          height="38"
      ...
      <tr height="20" style="mso-height-source: userset; height: 15pt">
        <td
          ...
          "
        >
          <slot class="ew-slot" name="tpx_print_label__barcode"></slot>
        </td>
      </tr>
      <tr height="17" style="mso-height-source: userset; height: 12.95pt">
        <td
          ...
          height="34"
          class="x42"
          style="border-bottom: 1px solid windowtext; height: 25.9pt"
        >
          Konsep :
        </td>
        <td
          ...
          height="33"
          class="x33"
          style="border-bottom: 1px solid windowtext; height: 25.15pt"
        ></td>
        <td
          rowspan="2"
          height="34"
      ...
      <tr height="17" style="mso-height-source: userset; height: 12.95pt"></tr>
      <tr height="24" style="mso-height-source: userset; height: 18pt">
        <td
          ...
          "
        >
          <slot class="ew-slot" name="tpx_print_label_store_name"></slot>
        </td>
        <td
          colspan="2"
          rowspan="3"
          ...
          "
        >
          {{:store_code.substring(0,5) }}
        </td>
      </tr>
      <tr height="8" style="mso-height-source: userset; height: 6pt"></tr>
      <tr height="24" style="mso-height-source: userset; height: 18pt"></tr>
      <![if supportMisalignedColumns]>
      <tr height="0" style="display: none">
        <td
          width="128"
          colspan="2"
          style="width: 96pt; mso-ignore: colspan"
        ></td>
        <td
          width="178"
          colspan="2"
          style="width: 133.5pt; mso-ignore: colspan"
        ></td>
