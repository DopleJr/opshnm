 ...
 * Page class
 */
class PrintLabelView extends PrintLabel
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PrintLabelView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "printlabellist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "printlabellist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "printlabellist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
