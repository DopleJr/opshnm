 ...
 * Page class
 */
class TransferbinDelete extends Transferbin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransferbinDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("transferbinlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("transferbinlist"); // Return to list
                return;
            }
        }
