 ...
 * Page class
 */
class CycleCountDelete extends CycleCount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CycleCountDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("cyclecountlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("cyclecountlist"); // Return to list
                return;
            }
        }
