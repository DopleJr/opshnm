 ...
 * Page class
 */
class AuditPickingOnlineView extends AuditPickingOnline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AuditPickingOnlineView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "auditpickingonlinelist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "auditpickingonlinelist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "auditpickingonlinelist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
