...
/**
 * Table class for strapi_webhooks
 */
class StrapiWebhooks extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'strapi_webhooks';
        $this->TableName = 'strapi_webhooks';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`strapi_webhooks`";
        $this->Dbid = 'DB';
        ...
        $this->headers->InputTextType = "text";
        $this->Fields['headers'] = &$this->headers;

        // events
        $this->events = new DbField(
            'strapi_webhooks',
            'strapi_webhooks',
            'x_events',
            'events',
        ...
        $this->events->InputTextType = "text";
        ...
        $this->enabled->Lookup = new Lookup('enabled', 'strapi_webhooks', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`strapi_webhooks`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->headers->DbValue = $row['headers'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("strapiwebhookslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "strapiwebhooksview") {
            return $Language->phrase("View");
        } elseif ($pageName == "strapiwebhooksedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "strapiwebhooksadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "StrapiWebhooksView";
            case Config("API_ADD_ACTION"):
                return "StrapiWebhooksAdd";
            case Config("API_EDIT_ACTION"):
                return "StrapiWebhooksEdit";
            case Config("API_DELETE_ACTION"):
                return "StrapiWebhooksDelete";
            case Config("API_LIST_ACTION"):
                return "StrapiWebhooksList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("strapiwebhooksview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("strapiwebhooksview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "strapiwebhooksadd?" . $this->getUrlParm($parm);
        } else {
            $url = "strapiwebhooksadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("strapiwebhooksedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("strapiwebhooksadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("strapiwebhooksdelete", $this->getUrlParm());
    }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->headers->setDbValue($row['headers']);
    ...
    public function renderListRow()
    {
        ...
        // headers
        $this->headers->ViewValue = $this->headers->CurrentValue;
        $this->headers->ViewCustomAttributes = "";
        ...
        // headers
        $this->headers->LinkCustomAttributes = "";
        $this->headers->HrefValue = "";
        $this->headers->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // headers
        $this->headers->setupEditAttributes();
        $this->headers->EditCustomAttributes = "";
        $this->headers->EditValue = $this->headers->CurrentValue;
        $this->headers->PlaceHolder = RemoveHtml($this->headers->caption());

        // events
        $this->events->setupEditAttributes();
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->headers);
