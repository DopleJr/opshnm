...
/**
 * Table class for box_picking_copy1
 */
class BoxPickingCopy1 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'box_picking_copy1';
        $this->TableName = 'box_picking_copy1';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`box_picking_copy1`";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`box_picking_copy1`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("boxpickingcopy1list");
    }
    ...
    {
        global $Language;
        if ($pageName == "boxpickingcopy1view") {
            return $Language->phrase("View");
        } elseif ($pageName == "boxpickingcopy1edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "boxpickingcopy1add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BoxPickingCopy1View";
            case Config("API_ADD_ACTION"):
                return "BoxPickingCopy1Add";
            case Config("API_EDIT_ACTION"):
                return "BoxPickingCopy1Edit";
            case Config("API_DELETE_ACTION"):
                return "BoxPickingCopy1Delete";
            case Config("API_LIST_ACTION"):
                return "BoxPickingCopy1List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("boxpickingcopy1view", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("boxpickingcopy1view", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "boxpickingcopy1add?" . $this->getUrlParm($parm);
        } else {
            $url = "boxpickingcopy1add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("boxpickingcopy1edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("boxpickingcopy1add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("boxpickingcopy1delete", $this->getUrlParm());
    }
