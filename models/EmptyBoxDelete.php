 ...
 * Page class
 */
class EmptyBoxDelete extends EmptyBox
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmptyBoxDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("emptyboxlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("emptyboxlist"); // Return to list
                return;
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->photo_before->UseColorbox) {
                ...
                $this->photo_before->LinkAttrs["data-rel"] = "empty_box_x_photo_before";
            ...
            if ($this->photo_after->UseColorbox) {
                ...
                $this->photo_after->LinkAttrs["data-rel"] = "empty_box_x_photo_after";
