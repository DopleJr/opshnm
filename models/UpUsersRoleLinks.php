...
/**
 * Table class for up_users_role_links
 */
class UpUsersRoleLinks extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'up_users_role_links';
        $this->TableName = 'up_users_role_links';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`up_users_role_links`";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`up_users_role_links`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("upusersrolelinkslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "upusersrolelinksview") {
            return $Language->phrase("View");
        } elseif ($pageName == "upusersrolelinksedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "upusersrolelinksadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UpUsersRoleLinksView";
            case Config("API_ADD_ACTION"):
                return "UpUsersRoleLinksAdd";
            case Config("API_EDIT_ACTION"):
                return "UpUsersRoleLinksEdit";
            case Config("API_DELETE_ACTION"):
                return "UpUsersRoleLinksDelete";
            case Config("API_LIST_ACTION"):
                return "UpUsersRoleLinksList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("upusersrolelinksview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("upusersrolelinksview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "upusersrolelinksadd?" . $this->getUrlParm($parm);
        } else {
            $url = "upusersrolelinksadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("upusersrolelinksedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("upusersrolelinksadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("upusersrolelinksdelete", $this->getUrlParm());
    }
