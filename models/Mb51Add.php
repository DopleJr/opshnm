...
class Mb51Add extends Mb51
{
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "mb51view") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // rcvsite
        $this->rcvsite->setDbValueDef($rsnew, $this->rcvsite->CurrentValue, null, false);

        // do_type
        $this->do_type->setDbValueDef($rsnew, $this->do_type->CurrentValue, null, false);
