 ...
 * Page class
 */
class ReportOutboundSearch extends ReportOutbound
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReportOutboundSearch";
    ...
    public function run()
    {
        ...
        $this->no_delivery->Visible = false;
        $this->truck_type->Visible = false;
        $this->seal_no->Visible = false;
        $this->truck_plate->Visible = false;
        $this->transporter->Visible = false;
        $this->no_hp->Visible = false;
        $this->checker->Visible = false;
        $this->admin->Visible = false;
        $this->remarks_box->Visible = false;
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "reportoutboundlist" . "?" . $srchStr;
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckDate($this->date_delivery->AdvancedSearch->SearchValue2, $this->date_delivery->formatPattern())) {
            $this->date_delivery->addErrorMessage($this->date_delivery->getErrorMessage(false));
        }
