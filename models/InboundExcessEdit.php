 ...
 * Page class
 */
class InboundExcessEdit extends InboundExcess
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InboundExcessEdit";
    ...
    protected function editRow()
    {
        ...
        // pallet_id
        $this->pallet_id->setDbValueDef($rsnew, $this->pallet_id->CurrentValue, "", $this->pallet_id->ReadOnly);
