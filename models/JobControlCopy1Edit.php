 ...
 * Page class
 */
class JobControlCopy1Edit extends JobControlCopy1
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JobControlCopy1Edit";
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($curVal != "") {
                ...
                if ($this->creation_date->ViewValue === null) { // Lookup from database
                    ...
                    $sqlWrk = $this->creation_date->Lookup->getSql(false, $filterWrk, '', $this, true, true);
                    $conn = Conn();
            ...
            if ($curVal != "") {
                ...
                if ($this->area->ViewValue === null) { // Lookup from database
                    ...
                    $sqlWrk = $this->area->Lookup->getSql(false, $filterWrk, '', $this, true, true);
                    $conn = Conn();
                    $config = $conn->getConfiguration();
                    $config->setResultCacheImpl($this->Cache);
                    $rswrk = $conn->executeCacheQuery($sqlWrk, [], [], $this->CacheProfile)->fetchAll();
            ...
            if ($this->creation_date->ViewValue !== null) { // Load from cache
                ...
                $sqlWrk = $this->creation_date->Lookup->getSql(true, $filterWrk, '', $this, false, true);
                $conn = Conn();
                $config = $conn->getConfiguration();
                $config->setResultCacheImpl($this->Cache);
                $rswrk = $conn->executeCacheQuery($sqlWrk, [], [], $this->CacheProfile)->fetchAll();
            ...
            if ($this->area->ViewValue !== null) { // Load from cache
                ...
                $sqlWrk = $this->area->Lookup->getSql(true, $filterWrk, '', $this, false, true);
                $conn = Conn();
                $config = $conn->getConfiguration();
                $config->setResultCacheImpl($this->Cache);
                $rswrk = $conn->executeCacheQuery($sqlWrk, [], [], $this->CacheProfile)->fetchAll();
