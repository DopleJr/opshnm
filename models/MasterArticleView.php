 ...
 * Page class
 */
class MasterArticleView extends MasterArticle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterArticleView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "masterarticlelist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "masterarticlelist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "masterarticlelist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
