...
/**
 * Table class for data_extra_stock
 */
class DataExtraStock extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'data_extra_stock';
        $this->TableName = 'data_extra_stock';
        $this->TableType = 'VIEW';
        ...
        $this->location->Lookup = new Lookup('location', 'data_extra_stock', true, 'location', ["location","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->ctn->Lookup = new Lookup('ctn', 'data_extra_stock', true, 'ctn', ["ctn","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->quantity->Lookup = new Lookup('quantity', 'data_extra_stock', true, 'quantity', ["quantity","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->description->Lookup = new Lookup('description', 'data_extra_stock', true, 'description', ["description","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->color_code->Lookup = new Lookup('color_code', 'data_extra_stock', true, 'color_code', ["color_code","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->no_box->Lookup = new Lookup('no_box', 'data_extra_stock', true, 'no_box', ["no_box","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->location_2nd->Lookup = new Lookup('location_2nd', 'data_extra_stock', true, 'location_2nd', ["location_2nd","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->date_created->Lookup = new Lookup('date_created', 'data_extra_stock', true, 'date_created', ["date_created","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->date_updated->Lookup = new Lookup('date_updated', 'data_extra_stock', true, 'date_updated', ["date_updated","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`data_extra_stock`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("dataextrastocklist");
    }
    ...
    {
        global $Language;
        if ($pageName == "dataextrastockview") {
            return $Language->phrase("View");
        } elseif ($pageName == "dataextrastockedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "dataextrastockadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DataExtraStockView";
            case Config("API_ADD_ACTION"):
                return "DataExtraStockAdd";
            case Config("API_EDIT_ACTION"):
                return "DataExtraStockEdit";
            case Config("API_DELETE_ACTION"):
                return "DataExtraStockDelete";
            case Config("API_LIST_ACTION"):
                return "DataExtraStockList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("dataextrastockview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("dataextrastockview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "dataextrastockadd?" . $this->getUrlParm($parm);
        } else {
            $url = "dataextrastockadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("dataextrastockedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("dataextrastockadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("dataextrastockdelete", $this->getUrlParm());
    }
