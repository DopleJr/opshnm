...
/**
 * Table class for admin_roles
 */
class AdminRoles extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'admin_roles';
        $this->TableName = 'admin_roles';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`admin_roles`";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`admin_roles`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("adminroleslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "adminrolesview") {
            return $Language->phrase("View");
        } elseif ($pageName == "adminrolesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "adminrolesadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("adminrolesview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("adminrolesview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "adminrolesadd?" . $this->getUrlParm($parm);
        } else {
            $url = "adminrolesadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("adminrolesedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("adminrolesadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("adminrolesdelete", $this->getUrlParm());
    }
