 ...
 * Page class
 */
class LocationsView extends Locations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LocationsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "locationslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "locationslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "locationslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
