...
class View1 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->article->Lookup = new Lookup('article', 'view1', true, 'article', ["article","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->description->Lookup = new Lookup('description', 'view1', true, 'description', ["description","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->color_code->Lookup = new Lookup('color_code', 'view1', true, 'color_code', ["color_code","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->color_desc->Lookup = new Lookup('color_desc', 'view1', true, 'color_desc', ["color_desc","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->size_code->Lookup = new Lookup('size_code', 'view1', true, 'size_code', ["size_code","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->size_desc->Lookup = new Lookup('size_desc', 'view1', true, 'size_desc', ["size_desc","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->season->Lookup = new Lookup('season', 'view1', true, 'season', ["season","","",""], [], [], [], [], [], [], '', '', "");
