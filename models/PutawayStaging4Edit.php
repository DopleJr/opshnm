 ...
 * Page class
 */
class PutawayStaging4Edit extends PutawayStaging4
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PutawayStaging4Edit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("putawaystaging4list"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "putawaystaging4list") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("putawaystaging4list"), "", $this->TableVar, true);
        $pageId = "edit";
