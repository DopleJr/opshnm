 ...
 * Page class
 */
class BoxPickingSearch extends BoxPicking
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BoxPickingSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "boxpickinglist" . "?" . $srchStr;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->picking_date->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->picking_date->AdvancedSearch->SearchValue, $this->picking_date->formatPattern()), $this->picking_date->formatPattern()));
            ...
            $this->date_delivery->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->date_delivery->AdvancedSearch->SearchValue, $this->date_delivery->formatPattern()), $this->date_delivery->formatPattern()));
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("boxpickinglist"), "", $this->TableVar, true);
        $pageId = "search";
