...
/**
 * Table class for monitor_cycle_count
 */
class MonitorCycleCount extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'monitor_cycle_count';
        $this->TableName = 'monitor_cycle_count';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`monitor_cycle_count`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`monitor_cycle_count`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("monitorcyclecountlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "monitorcyclecountview") {
            return $Language->phrase("View");
        } elseif ($pageName == "monitorcyclecountedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "monitorcyclecountadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MonitorCycleCountView";
            case Config("API_ADD_ACTION"):
                return "MonitorCycleCountAdd";
            case Config("API_EDIT_ACTION"):
                return "MonitorCycleCountEdit";
            case Config("API_DELETE_ACTION"):
                return "MonitorCycleCountDelete";
            case Config("API_LIST_ACTION"):
                return "MonitorCycleCountList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("monitorcyclecountview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("monitorcyclecountview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "monitorcyclecountadd?" . $this->getUrlParm($parm);
        } else {
            $url = "monitorcyclecountadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("monitorcyclecountedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("monitorcyclecountadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("monitorcyclecountdelete", $this->getUrlParm());
    }
