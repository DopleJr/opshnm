...
/**
 * Table class for cycle_count_offline
 */
class CycleCountOffline extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'cycle_count_offline';
        $this->TableName = 'cycle_count_offline';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`cycle_count_offline`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`cycle_count_offline`";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS `gtin`, '' AS `gtin2`, '' AS `gtin3`, '' AS `get_total`");
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`divisi`= 'offline'";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("cyclecountofflinelist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "cyclecountofflineedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "cyclecountofflineadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "CycleCountOfflineView";
            case Config("API_ADD_ACTION"):
                return "CycleCountOfflineAdd";
            case Config("API_EDIT_ACTION"):
                return "CycleCountOfflineEdit";
            case Config("API_DELETE_ACTION"):
                return "CycleCountOfflineDelete";
            case Config("API_LIST_ACTION"):
                return "CycleCountOfflineList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("cyclecountofflineview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("cyclecountofflineview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "cyclecountofflineadd?" . $this->getUrlParm($parm);
        } else {
            $url = "cyclecountofflineadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("cyclecountofflineedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("cyclecountofflineadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("cyclecountofflinedelete", $this->getUrlParm());
    }
    ...
    public function rowInserted($rsold, &$rsnew)
    {
        ...
        $sql4 = "UPDATE cycle_count SET `article` = '$_article1', `date_created` = '$currentDate', `divisi` = '$_divisi'  WHERE `id` = '".$rsnew["id"]."' ";
