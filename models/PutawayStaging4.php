...
/**
 * Table class for putaway_staging4
 */
class PutawayStaging4 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'putaway_staging4';
        $this->TableName = 'putaway_staging4';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`putaway_staging4`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`putaway_staging4`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("putawaystaging4list");
    }
    ...
    {
        global $Language;
        if ($pageName == "putawaystaging4view") {
            return $Language->phrase("View");
        } elseif ($pageName == "putawaystaging4edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "putawaystaging4add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PutawayStaging4View";
            case Config("API_ADD_ACTION"):
                return "PutawayStaging4Add";
            case Config("API_EDIT_ACTION"):
                return "PutawayStaging4Edit";
            case Config("API_DELETE_ACTION"):
                return "PutawayStaging4Delete";
            case Config("API_LIST_ACTION"):
                return "PutawayStaging4List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("putawaystaging4view", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("putawaystaging4view", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "putawaystaging4add?" . $this->getUrlParm($parm);
        } else {
            $url = "putawaystaging4add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawaystaging4edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawaystaging4add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("putawaystaging4delete", $this->getUrlParm());
    }
