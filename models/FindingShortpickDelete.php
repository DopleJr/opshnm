 ...
 * Page class
 */
class FindingShortpickDelete extends FindingShortpick
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FindingShortpickDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("findingshortpicklist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("findingshortpicklist"); // Return to list
                return;
            }
        }
