 ...
 * Page class
 */
class CycleCountOfflineDelete extends CycleCountOffline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CycleCountOfflineDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("cyclecountofflinelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("cyclecountofflinelist"); // Return to list
                return;
            }
        }
