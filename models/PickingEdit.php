 ...
 * Page class
 */
class PickingEdit extends Picking
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PickingEdit";
    ...
    protected function editRow()
    {
        ...
        // source_storage_bin
        $this->source_storage_bin->setDbValueDef($rsnew, $this->source_storage_bin->CurrentValue, null, $this->source_storage_bin->ReadOnly);

        // carton_number
        $this->carton_number->setDbValueDef($rsnew, $this->carton_number->CurrentValue, null, $this->carton_number->ReadOnly);
        ...
        // target_qty
        $this->target_qty->setDbValueDef($rsnew, $this->target_qty->CurrentValue, null, $this->target_qty->ReadOnly);
