 ...
 * Page class
 */
class CycleCountView extends CycleCount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CycleCountView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "cyclecountlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "cyclecountlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "cyclecountlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
