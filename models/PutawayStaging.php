...
/**
 * Table class for putaway_staging
 */
class PutawayStaging extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'putaway_staging';
        $this->TableName = 'putaway_staging';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`putaway_staging`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`putaway_staging`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("putawaystaginglist");
    }
    ...
    {
        global $Language;
        if ($pageName == "putawaystagingview") {
            return $Language->phrase("View");
        } elseif ($pageName == "putawaystagingedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "putawaystagingadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PutawayStagingView";
            case Config("API_ADD_ACTION"):
                return "PutawayStagingAdd";
            case Config("API_EDIT_ACTION"):
                return "PutawayStagingEdit";
            case Config("API_DELETE_ACTION"):
                return "PutawayStagingDelete";
            case Config("API_LIST_ACTION"):
                return "PutawayStagingList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("putawaystagingview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("putawaystagingview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "putawaystagingadd?" . $this->getUrlParm($parm);
        } else {
            $url = "putawaystagingadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawaystagingedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawaystagingadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("putawaystagingdelete", $this->getUrlParm());
    }
