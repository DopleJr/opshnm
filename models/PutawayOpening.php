...
/**
 * Table class for putaway_opening
 */
class PutawayOpening extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'putaway_opening';
        $this->TableName = 'putaway_opening';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`putaway_opening`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`putaway_opening`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("putawayopeninglist");
    }
    ...
    {
        global $Language;
        if ($pageName == "putawayopeningview") {
            return $Language->phrase("View");
        } elseif ($pageName == "putawayopeningedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "putawayopeningadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PutawayOpeningView";
            case Config("API_ADD_ACTION"):
                return "PutawayOpeningAdd";
            case Config("API_EDIT_ACTION"):
                return "PutawayOpeningEdit";
            case Config("API_DELETE_ACTION"):
                return "PutawayOpeningDelete";
            case Config("API_LIST_ACTION"):
                return "PutawayOpeningList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("putawayopeningview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("putawayopeningview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "putawayopeningadd?" . $this->getUrlParm($parm);
        } else {
            $url = "putawayopeningadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawayopeningedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawayopeningadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("putawayopeningdelete", $this->getUrlParm());
    }
