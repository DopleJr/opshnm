 ...
 * Page class
 */
class FindingShortpick2Add extends FindingShortpick2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FindingShortpick2Add";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "findingshortpick2view") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // avaiable
        $this->avaiable->setDbValueDef($rsnew, $this->avaiable->CurrentValue, null, false);
        ...
        // excess
        $this->excess->setDbValueDef($rsnew, $this->excess->CurrentValue, null, false);
        ...
        // date_shortpick
        $this->date_shortpick->setDbValueDef($rsnew, UnFormatDateTime($this->date_shortpick->CurrentValue, $this->date_shortpick->formatPattern()), null, false);
        ...
        // time_picking
        $this->time_picking->setDbValueDef($rsnew, UnFormatDateTime($this->time_picking->CurrentValue, $this->time_picking->formatPattern()), null, false);
