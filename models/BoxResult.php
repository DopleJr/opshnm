...
/**
 * Table class for box_result
 */
class BoxResult extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'box_result';
        $this->TableName = 'box_result';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`box_result`";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`box_result`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("boxresultlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "boxresultview") {
            return $Language->phrase("View");
        } elseif ($pageName == "boxresultedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "boxresultadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BoxResultView";
            case Config("API_ADD_ACTION"):
                return "BoxResultAdd";
            case Config("API_EDIT_ACTION"):
                return "BoxResultEdit";
            case Config("API_DELETE_ACTION"):
                return "BoxResultDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("boxresultview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("boxresultview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "boxresultadd?" . $this->getUrlParm($parm);
        } else {
            $url = "boxresultadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("boxresultedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("boxresultadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("boxresultdelete", $this->getUrlParm());
    }
