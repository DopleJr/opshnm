 ...
 * Page class
 */
class DataExtraStockView extends DataExtraStock
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DataExtraStockView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "dataextrastocklist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "dataextrastocklist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "dataextrastocklist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("dataextrastocklist"), "", $this->TableVar, true);
        $pageId = "view";
