 ...
 * Page class
 */
class MasterArticle2Add extends MasterArticle2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterArticle2Add";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "masterarticle2view") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // gtin
        $this->gtin->setDbValueDef($rsnew, $this->gtin->CurrentValue, null, false);
