 ...
 * Page class
 */
class MasterArticle2View extends MasterArticle2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterArticle2View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "masterarticle2list"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "masterarticle2list"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "masterarticle2list"; // Not page request, return to list
        }
        if ($returnUrl != "") {
