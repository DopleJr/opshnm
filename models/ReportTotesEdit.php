 ...
 * Page class
 */
class ReportTotesEdit extends ReportTotes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReportTotesEdit";
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'date_in' first before field var 'x_date_in'
        $val = $CurrentForm->hasValue("date_in") ? $CurrentForm->getValue("date_in") : $CurrentForm->getValue("x_date_in");
        if (!$this->date_in->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->date_in->Visible = false; // Disable update for API request
            } else {
                $this->date_in->setFormValue($val, true, $validate);
            }
            $this->date_in->CurrentValue = UnFormatDateTime($this->date_in->CurrentValue, $this->date_in->formatPattern());
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        $this->date_in->CurrentValue = $this->date_in->FormValue;
        $this->date_in->CurrentValue = UnFormatDateTime($this->date_in->CurrentValue, $this->date_in->formatPattern());
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->date_in->EditValue = HtmlEncode(FormatDateTime($this->date_in->CurrentValue, $this->date_in->formatPattern()));
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->in->FormValue)) {
        ...
        if ($this->date_in->Required) {
            if (!$this->date_in->IsDetailKey && EmptyValue($this->date_in->FormValue)) {
                $this->date_in->addErrorMessage(str_replace("%s", $this->date_in->caption(), $this->date_in->RequiredErrorMessage));
            }
        }
        if (!CheckDate($this->date_in->FormValue, $this->date_in->formatPattern())) {
            $this->date_in->addErrorMessage($this->date_in->getErrorMessage(false));
        }
    ...
    protected function editRow()
    {
        ...
        // store_id
        $this->store_id->setDbValueDef($rsnew, $this->store_id->CurrentValue, null, $this->store_id->ReadOnly);
        ...
        // date_in
        $this->date_in->setDbValueDef($rsnew, UnFormatDateTime($this->date_in->CurrentValue, $this->date_in->formatPattern()), null, $this->date_in->ReadOnly);
