...
class UserlevelsList extends Userlevels
{
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->userlevelname, $default, true); // userlevelname
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" form=\"fuserlevelslist\" data-ew-action=\"submit\" data-url=\"" . GetUrl($this->MultiDeleteUrl) . "\"data-data='{\"action\":\"show\"}'>" . $Language->phrase("DeleteSelectedLink") . "</button>";
        $item->Visible = $Security->canDelete();
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // userlevelname
            if ($this->userlevelname->UseFilter && !EmptyValue($this->userlevelname->AdvancedSearch->SearchValue)) {
                if (is_array($this->userlevelname->AdvancedSearch->SearchValue)) {
                    $this->userlevelname->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->userlevelname->AdvancedSearch->SearchValue);
                }
                $this->userlevelname->EditValue = explode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->userlevelname->AdvancedSearch->SearchValue);
            }
        }
