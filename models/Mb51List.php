...
class Mb51List extends Mb51
{
    ...
    // Table name
    public $TableName = 'mb51';

    // Page object name
    public $PageObjName = "Mb51List";
    ...
    public function __construct()
    {
        ...
        // Table object (mb51)
        if (!isset($GLOBALS["mb51"]) || get_class($GLOBALS["mb51"]) == PROJECT_NAMESPACE . "mb51") {
            $GLOBALS["mb51"] = &$this;
        }
        ...
        $this->MultiDeleteUrl = "mb51delete";
        $this->MultiUpdateUrl = "mb51update";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'mb51');
        }
    ...
    public function run()
    {
        ...
        $this->rcvsite->setVisibility();
        $this->do_type->setVisibility();
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->rcvsite->AdvancedSearch->toJson(), ","); // Field rcvsite
        $filterList = Concat($filterList, $this->do_type->AdvancedSearch->toJson(), ","); // Field do_type
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fmb51srch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field rcvsite
        $this->rcvsite->AdvancedSearch->SearchValue = @$filter["x_rcvsite"];
        $this->rcvsite->AdvancedSearch->SearchOperator = @$filter["z_rcvsite"];
        $this->rcvsite->AdvancedSearch->SearchCondition = @$filter["v_rcvsite"];
        $this->rcvsite->AdvancedSearch->SearchValue2 = @$filter["y_rcvsite"];
        $this->rcvsite->AdvancedSearch->SearchOperator2 = @$filter["w_rcvsite"];
        $this->rcvsite->AdvancedSearch->save();

        // Field do_type
        $this->do_type->AdvancedSearch->SearchValue = @$filter["x_do_type"];
        $this->do_type->AdvancedSearch->SearchOperator = @$filter["z_do_type"];
        $this->do_type->AdvancedSearch->SearchCondition = @$filter["v_do_type"];
        $this->do_type->AdvancedSearch->SearchValue2 = @$filter["y_do_type"];
        $this->do_type->AdvancedSearch->SearchOperator2 = @$filter["w_do_type"];
        $this->do_type->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->reference, $default, true); // reference
        $this->buildSearchSql($where, $this->rcvsite, $default, true); // rcvsite
        $this->buildSearchSql($where, $this->do_type, $default, true); // do_type
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->rcvsite->AdvancedSearch->save(); // rcvsite
            $this->do_type->AdvancedSearch->save(); // do_type
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->rcvsite;
        $searchFlds[] = &$this->do_type;
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->rcvsite->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->do_type->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
        ...
        $this->rcvsite->AdvancedSearch->unsetSession();
        $this->do_type->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->rcvsite->AdvancedSearch->load();
        $this->do_type->AdvancedSearch->load();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->rcvsite); // rcvsite
            $this->updateSort($this->do_type); // do_type
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->rcvsite->setSort("");
                $this->do_type->setSort("");
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fmb51list\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fmb51list\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("rcvsite", $this->createColumnOption("rcvsite"));
            $option->add("do_type", $this->createColumnOption("do_type"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fmb51srch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmb51srch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fmb51list"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function loadSearchValues()
    {
        ...
        // rcvsite
        if ($this->rcvsite->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->rcvsite->AdvancedSearch->SearchValue != "" || $this->rcvsite->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // do_type
        if ($this->do_type->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->do_type->AdvancedSearch->SearchValue != "" || $this->do_type->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    protected function newRow()
    {
        ...
        $row['rcvsite'] = $this->rcvsite->DefaultValue;
        $row['do_type'] = $this->do_type->DefaultValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // reference
            if ($this->reference->UseFilter && !EmptyValue($this->reference->AdvancedSearch->SearchValue)) {
                if (is_array($this->reference->AdvancedSearch->SearchValue)) {
                    $this->reference->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->reference->AdvancedSearch->SearchValue);
                }
                $this->reference->EditValue = explode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->reference->AdvancedSearch->SearchValue);
            }

            // rcvsite
            if ($this->rcvsite->UseFilter && !EmptyValue($this->rcvsite->AdvancedSearch->SearchValue)) {
                if (is_array($this->rcvsite->AdvancedSearch->SearchValue)) {
                    $this->rcvsite->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->rcvsite->AdvancedSearch->SearchValue);
                }
                $this->rcvsite->EditValue = explode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->rcvsite->AdvancedSearch->SearchValue);
            }

            // do_type
            if ($this->do_type->UseFilter && !EmptyValue($this->do_type->AdvancedSearch->SearchValue)) {
                if (is_array($this->do_type->AdvancedSearch->SearchValue)) {
                    $this->do_type->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->do_type->AdvancedSearch->SearchValue);
                }
                $this->do_type->EditValue = explode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->do_type->AdvancedSearch->SearchValue);
            }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fmb51list" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fmb51srch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    */
    ...
    public function pageImporting($reader, &$options)
    {
        ...
        $options["options"] = ["article", "quantity", "reference", "rcvsite","do_type","concept"];
        return true;
    }
