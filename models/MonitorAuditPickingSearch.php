 ...
 * Page class
 */
class MonitorAuditPickingSearch extends MonitorAuditPicking
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MonitorAuditPickingSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "monitorauditpickinglist" . "?" . $srchStr;
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("monitorauditpickinglist"), "", $this->TableVar, true);
        $pageId = "search";
