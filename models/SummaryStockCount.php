...
/**
 * Table class for summary_stock_count
 */
class SummaryStockCount extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'summary_stock_count';
        $this->TableName = 'summary_stock_count';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`summary_stock_count`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`summary_stock_count`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("summarystockcountlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "summarystockcountedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "summarystockcountadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "SummaryStockCountView";
            case Config("API_ADD_ACTION"):
                return "SummaryStockCountAdd";
            case Config("API_EDIT_ACTION"):
                return "SummaryStockCountEdit";
            case Config("API_DELETE_ACTION"):
                return "SummaryStockCountDelete";
            case Config("API_LIST_ACTION"):
                return "SummaryStockCountList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("summarystockcountview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("summarystockcountview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "summarystockcountadd?" . $this->getUrlParm($parm);
        } else {
            $url = "summarystockcountadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("summarystockcountedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("summarystockcountadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("summarystockcountdelete", $this->getUrlParm());
    }
