 ...
 * Page class
 */
class StockCountDelete extends StockCount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockCountDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("stockcountlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("stockcountlist"); // Return to list
                return;
            }
        }
