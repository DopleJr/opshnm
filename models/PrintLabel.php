...
/**
 * Table class for print_label
 */
class PrintLabel extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'print_label';
        $this->TableName = 'print_label';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`print_label`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`print_label`";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS `barcode`");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("printlabellist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "printlabeledit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "printlabeladd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "PrintLabelAdd";
            case Config("API_EDIT_ACTION"):
                return "PrintLabelEdit";
            case Config("API_DELETE_ACTION"):
                return "PrintLabelDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("printlabelview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("printlabelview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "printlabeladd?" . $this->getUrlParm($parm);
        } else {
            $url = "printlabeladd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("printlabeledit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("printlabeladd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("printlabeldelete", $this->getUrlParm());
    }
    ...
    public function rowInserted($rsold, &$rsnew)
    {
        ...
        if ($this->CurrentAction = "insert") {
            $url = "printlabelview/".$this->id->CurrentValue."?export=print";
        }
    }
