...
/**
 * Table class for empty_box
 */
class EmptyBox extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'empty_box';
        $this->TableName = 'empty_box';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`empty_box`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`empty_box`";
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`status`= 'Pending' AND `subject` = 'Empty Box' ";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("emptyboxlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "emptyboxedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "emptyboxadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("emptyboxview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("emptyboxview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "emptyboxadd?" . $this->getUrlParm($parm);
        } else {
            $url = "emptyboxadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("emptyboxedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("emptyboxadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("emptyboxdelete", $this->getUrlParm());
    }
