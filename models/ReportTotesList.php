 ...
 * Page class
 */
class ReportTotesList extends ReportTotes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReportTotesList";
    ...
    public $FormName = "freport_toteslist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "reporttotesadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "reporttotesdelete";
        $this->MultiUpdateUrl = "reporttotesupdate";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->out->AdvancedSearch->toJson(), ","); // Field out
        ...
        $filterList = Concat($filterList, $this->date_out->AdvancedSearch->toJson(), ","); // Field date_out
        $filterList = Concat($filterList, $this->date_in->AdvancedSearch->toJson(), ","); // Field date_in
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "freport_totessrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field out
        $this->out->AdvancedSearch->SearchValue = @$filter["x_out"];
        $this->out->AdvancedSearch->SearchOperator = @$filter["z_out"];
        $this->out->AdvancedSearch->SearchCondition = @$filter["v_out"];
        $this->out->AdvancedSearch->SearchValue2 = @$filter["y_out"];
        $this->out->AdvancedSearch->SearchOperator2 = @$filter["w_out"];
        $this->out->AdvancedSearch->save();
        ...
        // Field date_out
        $this->date_out->AdvancedSearch->SearchValue = @$filter["x_date_out"];
        $this->date_out->AdvancedSearch->SearchOperator = @$filter["z_date_out"];
        $this->date_out->AdvancedSearch->SearchCondition = @$filter["v_date_out"];
        $this->date_out->AdvancedSearch->SearchValue2 = @$filter["y_date_out"];
        $this->date_out->AdvancedSearch->SearchOperator2 = @$filter["w_date_out"];
        $this->date_out->AdvancedSearch->save();

        // Field date_in
        $this->date_in->AdvancedSearch->SearchValue = @$filter["x_date_in"];
        $this->date_in->AdvancedSearch->SearchOperator = @$filter["z_date_in"];
        $this->date_in->AdvancedSearch->SearchCondition = @$filter["v_date_in"];
        $this->date_in->AdvancedSearch->SearchValue2 = @$filter["y_date_in"];
        $this->date_in->AdvancedSearch->SearchOperator2 = @$filter["w_date_in"];
        $this->date_in->AdvancedSearch->save();
    }
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->out, $default, true); // out
        $this->buildSearchSql($where, $this->in, $default, true); // in
        $this->buildSearchSql($where, $this->diff, $default, true); // diff
        $this->buildSearchSql($where, $this->remarks, $default, true); // remarks
        $this->buildSearchSql($where, $this->date_out, $default, true); // date_out
        $this->buildSearchSql($where, $this->date_in, $default, true); // date_in
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->out->AdvancedSearch->save(); // out
            $this->in->AdvancedSearch->save(); // in
            $this->diff->AdvancedSearch->save(); // diff
            $this->remarks->AdvancedSearch->save(); // remarks
            $this->date_out->AdvancedSearch->save(); // date_out
            $this->date_in->AdvancedSearch->save(); // date_in
        }
        return $where;
    }
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->out->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->in->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->date_out->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->date_in->AdvancedSearch->issetSession()) {
            return true;
        }
        return false;
    }
    ...
    protected function resetAdvancedSearchParms()
    {
        ...
        $this->out->AdvancedSearch->unsetSession();
        $this->in->AdvancedSearch->unsetSession();
        $this->diff->AdvancedSearch->unsetSession();
        $this->remarks->AdvancedSearch->unsetSession();
        $this->date_out->AdvancedSearch->unsetSession();
        $this->date_in->AdvancedSearch->unsetSession();
    }
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->date_out->AdvancedSearch->load();
        $this->date_in->AdvancedSearch->load();
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if ($this->Command != "json") {
            $defaultSort = $this->date_out->Expression . " ASC"; // Set up default sort
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->date_out); // date_out
            $this->updateSort($this->date_in); // date_in
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->date_out->setSort("");
                $this->date_in->setSort("");
            }
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"freport_toteslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"freport_toteslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("out", $this->createColumnOption("out"));
            $option->add("in", $this->createColumnOption("in"));
            $option->add("diff", $this->createColumnOption("diff"));
            $option->add("remarks", $this->createColumnOption("remarks"));
            $option->add("date_out", $this->createColumnOption("date_out"));
            $option->add("date_in", $this->createColumnOption("date_in"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"freport_totessrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"freport_totessrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="freport_toteslist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->out->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->out->AdvancedSearch->SearchValue != "" || $this->out->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->in->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->in->AdvancedSearch->SearchValue != "" || $this->in->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // diff
        if ($this->diff->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // date_out
        if ($this->date_out->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->date_out->AdvancedSearch->SearchValue != "" || $this->date_out->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // date_in
        if ($this->date_in->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->date_in->AdvancedSearch->SearchValue != "" || $this->date_in->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        return $hasValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // out
            if ($this->out->UseFilter && !EmptyValue($this->out->AdvancedSearch->SearchValue)) {
                if (is_array($this->out->AdvancedSearch->SearchValue)) {
                    $this->out->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->out->AdvancedSearch->SearchValue);
                }
                $this->out->EditValue = explode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->out->AdvancedSearch->SearchValue);
            }

            // in
            if ($this->in->UseFilter && !EmptyValue($this->in->AdvancedSearch->SearchValue)) {
                if (is_array($this->in->AdvancedSearch->SearchValue)) {
                    $this->in->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->in->AdvancedSearch->SearchValue);
                }
                $this->in->EditValue = explode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->in->AdvancedSearch->SearchValue);
            }

            // diff
            if ($this->diff->UseFilter && !EmptyValue($this->diff->AdvancedSearch->SearchValue)) {
                if (is_array($this->diff->AdvancedSearch->SearchValue)) {
                    $this->diff->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->diff->AdvancedSearch->SearchValue);
                }
                $this->diff->EditValue = explode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->diff->AdvancedSearch->SearchValue);
            }
            ...
            // date_out
            if ($this->date_out->UseFilter && !EmptyValue($this->date_out->AdvancedSearch->SearchValue)) {
                if (is_array($this->date_out->AdvancedSearch->SearchValue)) {
                    $this->date_out->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->date_out->AdvancedSearch->SearchValue);
                }
                $this->date_out->EditValue = explode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->date_out->AdvancedSearch->SearchValue);
            }

            // date_in
            if ($this->date_in->UseFilter && !EmptyValue($this->date_in->AdvancedSearch->SearchValue)) {
                if (is_array($this->date_in->AdvancedSearch->SearchValue)) {
                    $this->date_in->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->date_in->AdvancedSearch->SearchValue);
                }
                $this->date_in->EditValue = explode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->date_in->AdvancedSearch->SearchValue);
            }
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="freport_toteslist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    {
        return $this->id->Visible || $this->store_id->Visible || $this->store_name->Visible || $this->out->Visible || $this->in->Visible || $this->diff->Visible || $this->remarks->Visible || $this->date_out->Visible || $this->date_in->Visible;
    }
