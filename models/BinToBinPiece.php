...
/**
 * Table class for bin_to_bin_piece
 */
class BinToBinPiece extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'bin_to_bin_piece';
        $this->TableName = 'bin_to_bin_piece';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`bin_to_bin_piece`";
        $this->Dbid = 'DB';
        ...
        // scan_location
        $this->scan_location = new DbField(
            'bin_to_bin_piece',
            'bin_to_bin_piece',
            'x_scan_location',
            'scan_location',
        ...
        $this->scan_location->InputTextType = "text";
        $this->scan_location->IsCustom = true; // Custom field
        $this->scan_location->Sortable = false; // Allow sort
        $this->Fields['scan_location'] = &$this->scan_location;
        ...
        $this->scan_article->Sortable = false; // Allow sort
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`bin_to_bin_piece`";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS `scan_location`, '' AS `scan_article`");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("bintobinpiecelist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "bintobinpieceedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "bintobinpieceadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BinToBinPieceView";
            case Config("API_ADD_ACTION"):
                return "BinToBinPieceAdd";
            case Config("API_EDIT_ACTION"):
                return "BinToBinPieceEdit";
            case Config("API_DELETE_ACTION"):
                return "BinToBinPieceDelete";
            case Config("API_LIST_ACTION"):
                return "BinToBinPieceList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("bintobinpieceview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("bintobinpieceview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "bintobinpieceadd?" . $this->getUrlParm($parm);
        } else {
            $url = "bintobinpieceadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("bintobinpieceedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("bintobinpieceadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("bintobinpiecedelete", $this->getUrlParm());
    }
    ...
    public function renderListRow()
    {
        ...
        $this->scan_location->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->scan_location->EditValue = $this->scan_location->CurrentValue;
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `bin_to_bin_piece`";
    ...
    public function recordsetSelecting(&$filter)
    {
        ...
        AddFilter($filter, "user = '".CurrentUserName()."'");
    }
