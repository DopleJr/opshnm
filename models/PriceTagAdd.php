 ...
 * Page class
 */
class PriceTagAdd extends PriceTag
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PriceTagAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("pricetaglist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "pricetaglist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "pricetagview") {
    ...
    {
        $this->location->DefaultValue = GetLastestLocationXtra();
        $this->location->OldValue = $this->location->DefaultValue;
        $this->ctn->DefaultValue = GetLastestCtn();
        $this->ctn->OldValue = $this->ctn->DefaultValue;
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("pricetaglist"), "", $this->TableVar, true);
