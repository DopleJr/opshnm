 ...
 * Page class
 */
class PutawayOpeningEdit extends PutawayOpening
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PutawayOpeningEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("putawayopeninglist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "putawayopeninglist") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("putawayopeninglist"), "", $this->TableVar, true);
        $pageId = "edit";
