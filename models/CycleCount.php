...
/**
 * Table class for cycle_count
 */
class CycleCount extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'cycle_count';
        $this->TableName = 'cycle_count';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`cycle_count`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->id->Lookup = new Lookup('id', 'cycle_count', true, 'id', ["id","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->id->Lookup = new Lookup('id', 'cycle_count', true, 'id', ["id","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->location->Lookup = new Lookup('location', 'cycle_count', true, 'location', ["location","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->location->Lookup = new Lookup('location', 'cycle_count', true, 'location', ["location","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->scan->Lookup = new Lookup('scan', 'cycle_count', true, 'scan', ["scan","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->scan->Lookup = new Lookup('scan', 'cycle_count', true, 'scan', ["scan","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->article->Lookup = new Lookup('article', 'cycle_count', true, 'article', ["article","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->article->Lookup = new Lookup('article', 'cycle_count', true, 'article', ["article","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->user->Lookup = new Lookup('user', 'cycle_count', true, 'user', ["user","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->user->Lookup = new Lookup('user', 'cycle_count', true, 'user', ["user","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->date_created->Lookup = new Lookup('date_created', 'cycle_count', true, 'date_created', ["date_created","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->date_created->Lookup = new Lookup('date_created', 'cycle_count', true, 'date_created', ["date_created","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->date_updated->Lookup = new Lookup('date_updated', 'cycle_count', true, 'date_updated', ["date_updated","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->date_updated->Lookup = new Lookup('date_updated', 'cycle_count', true, 'date_updated', ["date_updated","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->get_total->InputTextType = "text";
        $this->get_total->IsCustom = true; // Custom field
        $this->get_total->Sortable = false; // Allow sort
        $this->Fields['get_total'] = &$this->get_total;
        ...
        $this->divisi->Sortable = false; // Allow sort
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`cycle_count`";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS `get_total`");
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`divisi`= 'Online'";
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->get_total->DbValue = $row['get_total'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("cyclecountlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "cyclecountview") {
            return $Language->phrase("View");
        } elseif ($pageName == "cyclecountedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "cyclecountadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "CycleCountAdd";
            case Config("API_EDIT_ACTION"):
                return "CycleCountEdit";
            case Config("API_DELETE_ACTION"):
                return "CycleCountDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("cyclecountview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("cyclecountview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "cyclecountadd?" . $this->getUrlParm($parm);
        } else {
            $url = "cyclecountadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("cyclecountedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("cyclecountadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("cyclecountdelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->get_total->EditValue = $this->get_total->CurrentValue;
    ...
    public function rowInserted($rsold, &$rsnew)
    {
        ...
        $_divisi = 'Online';
        $sql4 = "UPDATE cycle_count SET `date_created` = '$currentDate', `divisi` = '$_divisi'  WHERE `id` = '".$rsnew["id"]."' ";
