 ...
 * Page class
 */
class PutawayStagingEdit extends PutawayStaging
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PutawayStagingEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("putawaystaginglist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "putawaystaginglist") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("putawaystaginglist"), "", $this->TableVar, true);
        $pageId = "edit";
