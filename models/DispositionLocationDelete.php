 ...
 * Page class
 */
class DispositionLocationDelete extends DispositionLocation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DispositionLocationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("dispositionlocationlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("dispositionlocationlist"); // Return to list
                return;
            }
        }
