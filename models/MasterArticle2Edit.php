 ...
 * Page class
 */
class MasterArticle2Edit extends MasterArticle2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterArticle2Edit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("masterarticle2list"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "masterarticle2list") {
    ...
    protected function editRow()
    {
        ...
        // gtin
        $this->gtin->setDbValueDef($rsnew, $this->gtin->CurrentValue, null, $this->gtin->ReadOnly);

        // color_code
        $this->color_code->setDbValueDef($rsnew, $this->color_code->CurrentValue, null, $this->color_code->ReadOnly);

        // color_desc
        $this->color_desc->setDbValueDef($rsnew, $this->color_desc->CurrentValue, null, $this->color_desc->ReadOnly);

        // size_code
        $this->size_code->setDbValueDef($rsnew, $this->size_code->CurrentValue, null, $this->size_code->ReadOnly);

        // size_desc
        $this->size_desc->setDbValueDef($rsnew, $this->size_desc->CurrentValue, null, $this->size_desc->ReadOnly);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("masterarticle2list"), "", $this->TableVar, true);
        $pageId = "edit";
