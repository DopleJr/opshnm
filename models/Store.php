...
class Store extends DbTable
{
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "storeedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "storeadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("storeview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("storeview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "storeadd?" . $this->getUrlParm($parm);
        } else {
            $url = "storeadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("storeedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("storeadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("storedelete", $this->getUrlParm());
    }
