...
class Report1Summary extends Report1
{
    ...
    public function loadGroupRowValues()
    {
        ...
        if ($this->GroupCount < $cnt) {
            $this->box_id->setGroupValue(reset($this->GroupRecords[$this->GroupCount]));
        } else {
            $this->box_id->setGroupValue("");
        }
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_SEARCH) { // Search row
            ...
            if ($this->RowTotalType == ROWTOTAL_GROUP) {
                $this->RowAttrs["data-group"] = $this->box_id->groupValue(); // Set up group attribute
            }

            // box_id
            $this->box_id->GroupViewValue = $this->box_id->groupValue();
            $this->box_id->CellCssClass = ($this->RowGroupLevel == 1 ? "ew-rpt-grp-summary-1" : "ew-rpt-grp-field-1");
            $this->box_id->ViewCustomAttributes = "";
            $this->box_id->GroupViewValue = DisplayGroupValue($this->box_id, $this->box_id->GroupViewValue);
            ...
            // box_id
            $this->box_id->GroupViewValue = $this->box_id->groupValue();
            $this->box_id->CellCssClass = "ew-rpt-grp-field-1";
            $this->box_id->ViewCustomAttributes = "";
            $this->box_id->GroupViewValue = DisplayGroupValue($this->box_id, $this->box_id->GroupViewValue);
            if (!$this->box_id->LevelBreak) {
                $this->box_id->GroupViewValue = "";
            } else {
                $this->box_id->LevelBreak = false;
            }
        ...
        if ($this->RowType == ROWTYPE_TOTAL) {
            // box_id
            $currentValue = $this->box_id->GroupViewValue;
            $viewValue = &$this->box_id->GroupViewValue;
            ...
            // box_id
            $currentValue = $this->box_id->groupValue();
            $viewValue = &$this->box_id->GroupViewValue;
            $viewAttrs = &$this->box_id->ViewAttrs;
            $cellAttrs = &$this->box_id->CellAttrs;
            $hrefValue = &$this->box_id->HrefValue;
    ...
    protected function getSort()
    {
        ...
        if ($this->getOrderBy() == "") {
            $useDefaultSort = true;
            if ($useDefaultSort) {
                $this->setOrderBy("`picking_date` ASC");
            }
        }
