...
/**
 * Table class for transfer bin
 */
class Transferbin extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'transferbin';
        $this->TableName = 'transfer bin';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`transfer bin`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`transfer bin`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("transferbinlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "transferbinedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "transferbinadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TransferbinView";
            case Config("API_ADD_ACTION"):
                return "TransferbinAdd";
            case Config("API_EDIT_ACTION"):
                return "TransferbinEdit";
            case Config("API_DELETE_ACTION"):
                return "TransferbinDelete";
            case Config("API_LIST_ACTION"):
                return "TransferbinList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("transferbinview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("transferbinview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "transferbinadd?" . $this->getUrlParm($parm);
        } else {
            $url = "transferbinadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("transferbinedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("transferbinadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("transferbindelete", $this->getUrlParm());
    }
