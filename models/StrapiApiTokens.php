...
/**
 * Table class for strapi_api_tokens
 */
class StrapiApiTokens extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'strapi_api_tokens';
        $this->TableName = 'strapi_api_tokens';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`strapi_api_tokens`";
        $this->Dbid = 'DB';
        ...
        $this->access_key->InputTextType = "text";
        $this->Fields['access_key'] = &$this->access_key;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`strapi_api_tokens`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->access_key->DbValue = $row['access_key'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("strapiapitokenslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "strapiapitokensview") {
            return $Language->phrase("View");
        } elseif ($pageName == "strapiapitokensedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "strapiapitokensadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "StrapiApiTokensView";
            case Config("API_ADD_ACTION"):
                return "StrapiApiTokensAdd";
            case Config("API_EDIT_ACTION"):
                return "StrapiApiTokensEdit";
            case Config("API_DELETE_ACTION"):
                return "StrapiApiTokensDelete";
            case Config("API_LIST_ACTION"):
                return "StrapiApiTokensList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("strapiapitokensview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("strapiapitokensview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "strapiapitokensadd?" . $this->getUrlParm($parm);
        } else {
            $url = "strapiapitokensadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("strapiapitokensedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("strapiapitokensadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("strapiapitokensdelete", $this->getUrlParm());
    }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->access_key->setDbValue($row['access_key']);
    ...
    public function renderListRow()
    {
        ...
        // access_key
        $this->access_key->ViewValue = $this->access_key->CurrentValue;
        $this->access_key->ViewCustomAttributes = "";
        ...
        // access_key
        $this->access_key->LinkCustomAttributes = "";
        $this->access_key->HrefValue = "";
        $this->access_key->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // access_key
        $this->access_key->setupEditAttributes();
        $this->access_key->EditCustomAttributes = "";
        if (!$this->access_key->Raw) {
            $this->access_key->CurrentValue = HtmlDecode($this->access_key->CurrentValue);
        }
        $this->access_key->EditValue = $this->access_key->CurrentValue;
        $this->access_key->PlaceHolder = RemoveHtml($this->access_key->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->access_key);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->access_key);
