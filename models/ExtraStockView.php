 ...
 * Page class
 */
class ExtraStockView extends ExtraStock
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ExtraStockView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "extrastocklist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "extrastocklist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "extrastocklist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
