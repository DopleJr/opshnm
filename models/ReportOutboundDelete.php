 ...
 * Page class
 */
class ReportOutboundDelete extends ReportOutbound
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReportOutboundDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("reportoutboundlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("reportoutboundlist"); // Return to list
                return;
            }
        }
