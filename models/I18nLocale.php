...
/**
 * Table class for i18n_locale
 */
class I18nLocale extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'i18n_locale';
        $this->TableName = 'i18n_locale';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`i18n_locale`";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`i18n_locale`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("i18nlocalelist");
    }
    ...
    {
        global $Language;
        if ($pageName == "i18nlocaleview") {
            return $Language->phrase("View");
        } elseif ($pageName == "i18nlocaleedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "i18nlocaleadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "I18nLocaleView";
            case Config("API_ADD_ACTION"):
                return "I18nLocaleAdd";
            case Config("API_EDIT_ACTION"):
                return "I18nLocaleEdit";
            case Config("API_DELETE_ACTION"):
                return "I18nLocaleDelete";
            case Config("API_LIST_ACTION"):
                return "I18nLocaleList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("i18nlocaleview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("i18nlocaleview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "i18nlocaleadd?" . $this->getUrlParm($parm);
        } else {
            $url = "i18nlocaleadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("i18nlocaleedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("i18nlocaleadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("i18nlocaledelete", $this->getUrlParm());
    }
