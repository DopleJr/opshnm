 ...
 * Page class
 */
class BoxPickingDelete extends BoxPicking
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BoxPickingDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("boxpickinglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("boxpickinglist"); // Return to list
                return;
            }
        }
