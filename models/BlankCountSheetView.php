 ...
 * Page class
 */
class BlankCountSheetView extends BlankCountSheet
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BlankCountSheetView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "blankcountsheetlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "blankcountsheetlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "blankcountsheetlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
