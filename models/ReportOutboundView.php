 ...
 * Page class
 */
class ReportOutboundView extends ReportOutbound
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReportOutboundView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "reportoutboundlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "reportoutboundlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "reportoutboundlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
