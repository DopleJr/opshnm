 ...
 * Page class
 */
class DispositionLocationView extends DispositionLocation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DispositionLocationView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "dispositionlocationlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "dispositionlocationlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "dispositionlocationlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
