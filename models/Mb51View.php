    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "mb51list"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "mb51list"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "mb51list"; // Not page request, return to list
        }
        if ($returnUrl != "") {
