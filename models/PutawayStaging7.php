...
/**
 * Table class for putaway_staging7
 */
class PutawayStaging7 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'putaway_staging7';
        $this->TableName = 'putaway_staging7';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`putaway_staging7`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`putaway_staging7`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("putawaystaging7list");
    }
    ...
    {
        global $Language;
        if ($pageName == "putawaystaging7view") {
            return $Language->phrase("View");
        } elseif ($pageName == "putawaystaging7edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "putawaystaging7add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PutawayStaging7View";
            case Config("API_ADD_ACTION"):
                return "PutawayStaging7Add";
            case Config("API_EDIT_ACTION"):
                return "PutawayStaging7Edit";
            case Config("API_DELETE_ACTION"):
                return "PutawayStaging7Delete";
            case Config("API_LIST_ACTION"):
                return "PutawayStaging7List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("putawaystaging7view", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("putawaystaging7view", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "putawaystaging7add?" . $this->getUrlParm($parm);
        } else {
            $url = "putawaystaging7add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawaystaging7edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawaystaging7add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("putawaystaging7delete", $this->getUrlParm());
    }
