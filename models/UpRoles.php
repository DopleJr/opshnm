...
/**
 * Table class for up_roles
 */
class UpRoles extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'up_roles';
        $this->TableName = 'up_roles';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`up_roles`";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`up_roles`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("uproleslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "uprolesview") {
            return $Language->phrase("View");
        } elseif ($pageName == "uprolesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "uprolesadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("uprolesview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("uprolesview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "uprolesadd?" . $this->getUrlParm($parm);
        } else {
            $url = "uprolesadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("uprolesedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("uprolesadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("uprolesdelete", $this->getUrlParm());
    }
