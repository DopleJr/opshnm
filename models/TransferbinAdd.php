 ...
 * Page class
 */
class TransferbinAdd extends Transferbin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransferbinAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("transferbinlist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "transferbinlist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "transferbinview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // from_bin
        $this->from_bin->setDbValueDef($rsnew, $this->from_bin->CurrentValue, "", false);

        // ctn
        $this->ctn->setDbValueDef($rsnew, $this->ctn->CurrentValue, "", false);

        // to_bin
        $this->to_bin->setDbValueDef($rsnew, $this->to_bin->CurrentValue, "", false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("transferbinlist"), "", $this->TableVar, true);
