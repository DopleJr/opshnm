 ...
 * Page class
 */
class PrintLabelDelete extends PrintLabel
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PrintLabelDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("printlabellist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("printlabellist"); // Return to list
                return;
            }
        }
