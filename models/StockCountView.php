 ...
 * Page class
 */
class StockCountView extends StockCount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockCountView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "stockcountlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "stockcountlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "stockcountlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
