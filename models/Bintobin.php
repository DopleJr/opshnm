...
class Bintobin extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("bintobinlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "bintobinview") {
            return $Language->phrase("View");
        } elseif ($pageName == "bintobinedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "bintobinadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("bintobinview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("bintobinview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "bintobinadd?" . $this->getUrlParm($parm);
        } else {
            $url = "bintobinadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("bintobinedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("bintobinadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("bintobindelete", $this->getUrlParm());
    }
