...
class Mb51Delete extends Mb51
{
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("mb51list"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("mb51list"); // Return to list
                return;
            }
        }
