 ...
 * Page class
 */
class TransferbinView extends Transferbin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransferbinView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "transferbinlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "transferbinlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "transferbinlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
