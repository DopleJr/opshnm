...
class TransferBinPieceList extends TransferBinPiece
{
    ...
    protected function setupSortOrder()
    {
        ...
        if ($this->Command != "json") {
            $defaultSort = $this->date_upload->Expression . " ASC" . ", " . $this->source_location->Expression . " ASC" . ", " . $this->article->Expression . " ASC"; // Set up default sort
    ...
    {
        return $this->source_location->Visible || $this->article->Visible || $this->destination_location->Visible || $this->su->Visible || $this->user->Visible || $this->date_upload->Visible || $this->date_confirmation->Visible;
    }
