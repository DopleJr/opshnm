...
/**
 * Table class for checking_vas
 */
class CheckingVas extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'checking_vas';
        $this->TableName = 'checking_vas';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`checking_vas`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->id->Lookup = new Lookup('id', 'checking_vas', true, 'id', ["id","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->id->Lookup = new Lookup('id', 'checking_vas', true, 'id', ["id","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        // filter_shipment
        $this->filter_shipment = new DbField(
            'checking_vas',
            'checking_vas',
            'x_filter_shipment',
            'filter_shipment',
        ...
        $this->filter_shipment->InputTextType = "text";
        $this->filter_shipment->IsCustom = true; // Custom field
        $this->filter_shipment->Sortable = false; // Allow sort
        $this->filter_shipment->SelectMultiple = true; // Multiple select
        switch ($CurrentLanguage) {
            case "en-US":
                $this->filter_shipment->Lookup = new Lookup('filter_shipment', 'vas_validation', true, 'shipment', ["shipment","","",""], [], ["x_order[]"], [], [], [], [], '`shipment` ASC', '', "`shipment`");
                break;
            default:
                $this->filter_shipment->Lookup = new Lookup('filter_shipment', 'vas_validation', true, 'shipment', ["shipment","","",""], [], ["x_order[]"], [], [], [], [], '`shipment` ASC', '', "`shipment`");
                break;
        }
        $this->Fields['filter_shipment'] = &$this->filter_shipment;
        ...
        $this->order->SelectMultiple = true; // Multiple select
        $this->order->UseFilter = true; // Table header filter
        switch ($CurrentLanguage) {
            case "en-US":
                $this->order->Lookup = new Lookup('order', 'vas_validation', true, 'order', ["order","","",""], ["x_filter_shipment[]"], ["x_po","x_sap_art","x_sub_index","x_concept","x_ctn","x_qty_oss","x_shipment","x_aju","x_snow","x_date_upload"], ["shipment"], ["x_shipment"], ["po","sap_art","sub_index","concept","ctn","season2","qty_oss","shipment","aju","snow","actual_price","price_foto","remarks","date_upload"], ["x_po","x_sap_art","x_sub_index","x_concept","x_ctn","x_season2","x_qty_oss","x_shipment","x_aju","x_snow","x_actual_price","x_price_foto","x_remarks","x_date_upload"], '`order` ASC', '', "`order`");
                break;
            default:
                $this->order->Lookup = new Lookup('order', 'vas_validation', true, 'order', ["order","","",""], ["x_filter_shipment[]"], ["x_po","x_sap_art","x_sub_index","x_concept","x_ctn","x_qty_oss","x_shipment","x_aju","x_snow","x_date_upload"], ["shipment"], ["x_shipment"], ["po","sap_art","sub_index","concept","ctn","season2","qty_oss","shipment","aju","snow","actual_price","price_foto","remarks","date_upload"], ["x_po","x_sap_art","x_sub_index","x_concept","x_ctn","x_season2","x_qty_oss","x_shipment","x_aju","x_snow","x_actual_price","x_price_foto","x_remarks","x_date_upload"], '`order` ASC', '', "`order`");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->sap_art->Lookup = new Lookup('sap_art', 'vas_validation', true, 'sap_art', ["sap_art","","",""], ["x_order[]"], [], ["order"], ["x_order"], [], [], '', '', "`sap_art`");
                break;
            default:
                $this->sap_art->Lookup = new Lookup('sap_art', 'vas_validation', true, 'sap_art', ["sap_art","","",""], ["x_order[]"], [], ["order"], ["x_order"], [], [], '', '', "`sap_art`");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->sub_index->Lookup = new Lookup('sub_index', 'vas_validation', true, 'sub_index', ["sub_index","","",""], ["x_order[]"], [], ["order"], ["x_order"], [], [], '', '', "`sub_index`");
                break;
            default:
                $this->sub_index->Lookup = new Lookup('sub_index', 'vas_validation', true, 'sub_index', ["sub_index","","",""], ["x_order[]"], [], ["order"], ["x_order"], [], [], '', '', "`sub_index`");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->concept->Lookup = new Lookup('concept', 'vas_validation', true, 'concept', ["concept","","",""], ["x_order[]"], [], ["order"], ["x_order"], [], [], '', '', "`concept`");
                break;
            default:
                $this->concept->Lookup = new Lookup('concept', 'vas_validation', true, 'concept', ["concept","","",""], ["x_order[]"], [], ["order"], ["x_order"], [], [], '', '', "`concept`");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->season2->Lookup = new Lookup('season2', 'checking_vas', true, 'season2', ["season2","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->season2->Lookup = new Lookup('season2', 'checking_vas', true, 'season2', ["season2","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->qty_oss->Sortable = false; // Allow sort
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->shipment->Lookup = new Lookup('shipment', 'vas_validation', true, 'shipment', ["shipment","","",""], ["x_order[]"], [], ["order"], ["x_order"], [], [], '', '', "`shipment`");
                break;
            default:
                $this->shipment->Lookup = new Lookup('shipment', 'vas_validation', true, 'shipment', ["shipment","","",""], ["x_order[]"], [], ["order"], ["x_order"], [], [], '', '', "`shipment`");
                break;
        ...
        $this->aju->Sortable = false; // Allow sort
        $this->aju->UseFilter = true; // Table header filter
        switch ($CurrentLanguage) {
            case "en-US":
                $this->aju->Lookup = new Lookup('aju', 'vas_validation', true, 'aju', ["aju","","",""], ["x_order[]"], [], ["order"], ["x_order"], [], [], '', '', "`aju`");
                break;
            default:
                $this->aju->Lookup = new Lookup('aju', 'vas_validation', true, 'aju', ["aju","","",""], ["x_order[]"], [], ["order"], ["x_order"], [], [], '', '', "`aju`");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->snow->Lookup = new Lookup('snow', 'vas_validation', true, 'snow', ["snow","","",""], ["x_order[]"], [], ["order"], ["x_order"], [], [], '', '', "`snow`");
                break;
            default:
                $this->snow->Lookup = new Lookup('snow', 'vas_validation', true, 'snow', ["snow","","",""], ["x_order[]"], [], ["order"], ["x_order"], [], [], '', '', "`snow`");
                break;
        ...
        $this->actual_price->Required = true; // Required field
        $this->actual_price->UseFilter = true; // Table header filter
        switch ($CurrentLanguage) {
            case "en-US":
                $this->actual_price->Lookup = new Lookup('actual_price', 'checking_vas', true, 'actual_price', ["actual_price","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->actual_price->Lookup = new Lookup('actual_price', 'checking_vas', true, 'actual_price', ["actual_price","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->price_foto->Sortable = false; // Allow sort
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->remarks->Lookup = new Lookup('remarks', 'checking_vas', true, 'remarks', ["remarks","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->remarks->Lookup = new Lookup('remarks', 'checking_vas', true, 'remarks', ["remarks","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->user->Lookup = new Lookup('user', 'checking_vas', true, 'user', ["user","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->user->Lookup = new Lookup('user', 'checking_vas', true, 'user', ["user","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->status->Lookup = new Lookup('status', 'checking_vas', true, 'status', ["status","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->status->Lookup = new Lookup('status', 'checking_vas', true, 'status', ["status","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->date_update->Lookup = new Lookup('date_update', 'checking_vas', true, 'date_update', ["date_update","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->date_update->Lookup = new Lookup('date_update', 'checking_vas', true, 'date_update', ["date_update","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->time_update->Lookup = new Lookup('time_update', 'checking_vas', true, 'time_update', ["time_update","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->time_update->Lookup = new Lookup('time_update', 'checking_vas', true, 'time_update', ["time_update","","",""], [], [], [], [], [], [], '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`checking_vas`";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS `filter_shipment`");
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->filter_shipment->DbValue = $row['filter_shipment'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("checkingvaslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "checkingvasedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "checkingvasadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "CheckingVasView";
            case Config("API_ADD_ACTION"):
                return "CheckingVasAdd";
            case Config("API_EDIT_ACTION"):
                return "CheckingVasEdit";
            case Config("API_DELETE_ACTION"):
                return "CheckingVasDelete";
            case Config("API_LIST_ACTION"):
                return "CheckingVasList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("checkingvasview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("checkingvasview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "checkingvasadd?" . $this->getUrlParm($parm);
        } else {
            $url = "checkingvasadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("checkingvasedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("checkingvasadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("checkingvasdelete", $this->getUrlParm());
    }
    ...
    public function renderListRow()
    {
        ...
        $this->filter_shipment->TooltipValue = "";
        ...
        if ($this->price_foto->UseColorbox) {
            ...
            $this->price_foto->LinkAttrs["data-rel"] = "checking_vas_x_price_foto";
    ...
    public function rowInserting($rsold, &$rsnew)
    {
        ...
        // To cancel, set return value to false
        	$_order  = $rsnew["order"];
        	$_po  = $rsnew["po"];
        	$_sap_art  = $rsnew["sap_art"];
        	$_actual_price  = $rsnew["actual_price"];
        	$_snow  = $rsnew["snow"];
        	$_price_foto  = $rsnew["price_foto"];
        	$_status = 'Done';
        	$_user = CurrentUsername();
        	$_date = CurrentDate();
        	$_time = CurrentTime();
        	$compare1 = "SELECT count(*) FROM `vas_validation` WHERE `order` =  '$_order' AND `po` =  '$_po' AND `sap_art` =  '$_sap_art' AND `status` = 'Pending' ";
            $_compare1 = ExecuteScalar($compare1);
            $compare2 = "SELECT count(*) FROM `vas_validation` WHERE `order` =  '$_order' AND `po` =  '$_po' AND `sap_art` =  '$_sap_art' AND `status` = 'Done' ";
            $_compare2 = ExecuteScalar($compare2);
            $dateupdate = "SELECT `date_update` FROM `vas_validation` WHERE `order` =  '$_order' AND `po` =  '$_po' AND `sap_art` =  '$_sap_art' AND `status` = 'Done' ";
            $_dateupdate = ExecuteScalar($dateupdate);
            $timeupdate = "SELECT `time_update` FROM `vas_validation` WHERE `order` =  '$_order' AND `po` =  '$_po' AND `sap_art` =  '$_sap_art' AND `status` = 'Done' ";
            $_timeupdate = ExecuteScalar($timeupdate);

            //Pre Insert QR
            $update = "UPDATE `vas_validation` SET `remarks` = 'NO CHANGE',`status` = '$_status',`actual_price` = '$_actual_price',`price_foto` = '$_price_foto', `user` = '$_user' , `date_update` = '$_date', `time_update` = '$_time' WHERE `order` =  '$_order' AND `po` =  '$_po' AND `sap_art` =  '$_sap_art' AND `status` = 'Pending' ";
            $update2 = "UPDATE `vas_validation` SET `remarks` = 'CHANGE',`status` = '$_status',`actual_price` = '$_actual_price',`price_foto` = '$_price_foto', `user` = '$_user' , `date_update` = '$_date', `time_update` = '$_time' WHERE `order` =  '$_order' AND `po` =  '$_po' AND `sap_art` =  '$_sap_art' AND `status` = 'Pending' ";
            $drop = "DELETE FROM `vas_validation` WHERE `order` =  '$_order' AND `po` =  '$_po' AND `sap_art` =  '$_sap_art' AND `status` IS NULL ";
            if ( $_compare1 == 1 && $_actual_price == $_snow ){
            	ExecuteStatement($update);
            	ExecuteStatement($drop);
            	$this->setSuccessMessage("ON Updated Price No Change");
            	return true;	
            }
            if ( $_compare1 == 1 && $_actual_price !== $_snow ){
            	ExecuteStatement($update2);
            	ExecuteStatement($drop);
            	$this->setSuccessMessage("ON Updated Price Change");
            	return true;	
            }
            if ( $_compare2 == 1 ){
            	$this->setWarningMessage("ON Updated At "  .$_dateupdate. " AND "  .$_timeupdate );
            	return false;
            }
            else {
            	$this->setFailureMessage("ON Not Found");
            	return false;	
            }
    }
    ...
    {
        //Log("Row Inserted");
        $_result_true = "DELETE FROM`vas_validation` WHERE `status` IS NULL ";
