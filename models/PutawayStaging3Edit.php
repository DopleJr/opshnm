 ...
 * Page class
 */
class PutawayStaging3Edit extends PutawayStaging3
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PutawayStaging3Edit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("putawaystaging3list"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "putawaystaging3list") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("putawaystaging3list"), "", $this->TableVar, true);
        $pageId = "edit";
