 ...
 * Page class
 */
class OutboundReportSummary extends OutboundReport
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'Outbound Report';

    // Page object name
    public $PageObjName = "OutboundReportSummary";
    ...
    public function __construct()
    {
        ...
        // Table object (OutboundReport)
        if (!isset($GLOBALS["OutboundReport"]) || get_class($GLOBALS["OutboundReport"]) == PROJECT_NAMESPACE . "OutboundReport") {
            $GLOBALS["OutboundReport"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Outbound Report');
        }
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fOutboundReportsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    {
        return $this->id->Visible || $this->Week->Visible || $this->box_id->Visible || $this->date_delivery->Visible || $this->box_type->Visible || $this->check_by->Visible || $this->quantity->Visible || $this->concept->Visible || $this->store_name->Visible || $this->remark->Visible || $this->no_delivery->Visible || $this->truck_type->Visible || $this->seal_no->Visible || $this->truck_plate->Visible || $this->transporter->Visible || $this->no_hp->Visible || $this->checker->Visible || $this->admin->Visible || $this->remarks_box->Visible || $this->date_created->Visible || $this->date_updated->Visible;
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fOutboundReportsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fOutboundReportsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
