 ...
 * Page class
 */
class FindingShortpick2View extends FindingShortpick2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FindingShortpick2View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "findingshortpick2list"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "findingshortpick2list"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "findingshortpick2list"; // Not page request, return to list
        }
        if ($returnUrl != "") {
