 ...
 * Page class
 */
class ExtraStockList extends ExtraStock
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ExtraStockList";
    ...
    public $FormName = "fextra_stocklist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "extrastockadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "extrastockdelete";
        $this->MultiUpdateUrl = "extrastockupdate";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->art6->AdvancedSearch->toJson(), ","); // Field art6
        $filterList = Concat($filterList, $this->art9->AdvancedSearch->toJson(), ","); // Field art9
        $filterList = Concat($filterList, $this->art11->AdvancedSearch->toJson(), ","); // Field art11
        ...
        $filterList = Concat($filterList, $this->no_box->AdvancedSearch->toJson(), ","); // Field no_box
        $filterList = Concat($filterList, $this->location_2nd->AdvancedSearch->toJson(), ","); // Field location_2nd
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fextra_stocksrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field art6
        $this->art6->AdvancedSearch->SearchValue = @$filter["x_art6"];
        $this->art6->AdvancedSearch->SearchOperator = @$filter["z_art6"];
        $this->art6->AdvancedSearch->SearchCondition = @$filter["v_art6"];
        $this->art6->AdvancedSearch->SearchValue2 = @$filter["y_art6"];
        $this->art6->AdvancedSearch->SearchOperator2 = @$filter["w_art6"];
        $this->art6->AdvancedSearch->save();

        // Field art9
        $this->art9->AdvancedSearch->SearchValue = @$filter["x_art9"];
        $this->art9->AdvancedSearch->SearchOperator = @$filter["z_art9"];
        $this->art9->AdvancedSearch->SearchCondition = @$filter["v_art9"];
        $this->art9->AdvancedSearch->SearchValue2 = @$filter["y_art9"];
        $this->art9->AdvancedSearch->SearchOperator2 = @$filter["w_art9"];
        $this->art9->AdvancedSearch->save();

        // Field art11
        $this->art11->AdvancedSearch->SearchValue = @$filter["x_art11"];
        $this->art11->AdvancedSearch->SearchOperator = @$filter["z_art11"];
        $this->art11->AdvancedSearch->SearchCondition = @$filter["v_art11"];
        $this->art11->AdvancedSearch->SearchValue2 = @$filter["y_art11"];
        $this->art11->AdvancedSearch->SearchOperator2 = @$filter["w_art11"];
        $this->art11->AdvancedSearch->save();
        ...
        // Field no_box
        $this->no_box->AdvancedSearch->SearchValue = @$filter["x_no_box"];
        $this->no_box->AdvancedSearch->SearchOperator = @$filter["z_no_box"];
        $this->no_box->AdvancedSearch->SearchCondition = @$filter["v_no_box"];
        $this->no_box->AdvancedSearch->SearchValue2 = @$filter["y_no_box"];
        $this->no_box->AdvancedSearch->SearchOperator2 = @$filter["w_no_box"];
        $this->no_box->AdvancedSearch->save();

        // Field location_2nd
        $this->location_2nd->AdvancedSearch->SearchValue = @$filter["x_location_2nd"];
        $this->location_2nd->AdvancedSearch->SearchOperator = @$filter["z_location_2nd"];
        $this->location_2nd->AdvancedSearch->SearchCondition = @$filter["v_location_2nd"];
        $this->location_2nd->AdvancedSearch->SearchValue2 = @$filter["y_location_2nd"];
        $this->location_2nd->AdvancedSearch->SearchOperator2 = @$filter["w_location_2nd"];
        $this->location_2nd->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->art6, $default, true); // art6
        $this->buildSearchSql($where, $this->art9, $default, true); // art9
        $this->buildSearchSql($where, $this->art11, $default, true); // art11
        ...
        $this->buildSearchSql($where, $this->no_box, $default, true); // no_box
        $this->buildSearchSql($where, $this->location_2nd, $default, true); // location_2nd
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->art6->AdvancedSearch->save(); // art6
            $this->art9->AdvancedSearch->save(); // art9
            $this->art11->AdvancedSearch->save(); // art11
            ...
            $this->no_box->AdvancedSearch->save(); // no_box
            $this->location_2nd->AdvancedSearch->save(); // location_2nd
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->art6;
        $searchFlds[] = &$this->art9;
        $searchFlds[] = &$this->art11;
        ...
        $searchFlds[] = &$this->no_box;
        $searchFlds[] = &$this->location_2nd;
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->art6->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->art9->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->art11->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->no_box->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->location_2nd->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
        ...
        $this->art6->AdvancedSearch->unsetSession();
        $this->art9->AdvancedSearch->unsetSession();
        $this->art11->AdvancedSearch->unsetSession();
        ...
        $this->no_box->AdvancedSearch->unsetSession();
        $this->location_2nd->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->art6->AdvancedSearch->load();
        $this->art9->AdvancedSearch->load();
        $this->art11->AdvancedSearch->load();
        ...
        $this->no_box->AdvancedSearch->load();
        $this->location_2nd->AdvancedSearch->load();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->no_box); // no_box
            $this->updateSort($this->location_2nd); // location_2nd
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fextra_stocklist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fextra_stocklist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("no_box", $this->createColumnOption("no_box"));
            $option->add("location_2nd", $this->createColumnOption("location_2nd"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fextra_stocksrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fextra_stocksrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fextra_stocklist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function loadSearchValues()
    {
        ...
        // art6
        if ($this->art6->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->art6->AdvancedSearch->SearchValue != "" || $this->art6->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // art9
        if ($this->art9->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->art9->AdvancedSearch->SearchValue != "" || $this->art9->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // art11
        if ($this->art11->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->art11->AdvancedSearch->SearchValue != "" || $this->art11->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // no_box
        if ($this->no_box->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->no_box->AdvancedSearch->SearchValue != "" || $this->no_box->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // location_2nd
        if ($this->location_2nd->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->location_2nd->AdvancedSearch->SearchValue != "" || $this->location_2nd->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // no_box
            if ($this->no_box->UseFilter && !EmptyValue($this->no_box->AdvancedSearch->SearchValue)) {
                if (is_array($this->no_box->AdvancedSearch->SearchValue)) {
                    $this->no_box->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->no_box->AdvancedSearch->SearchValue);
                }
                $this->no_box->EditValue = explode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->no_box->AdvancedSearch->SearchValue);
            }

            // location_2nd
            if ($this->location_2nd->UseFilter && !EmptyValue($this->location_2nd->AdvancedSearch->SearchValue)) {
                if (is_array($this->location_2nd->AdvancedSearch->SearchValue)) {
                    $this->location_2nd->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->location_2nd->AdvancedSearch->SearchValue);
                }
                $this->location_2nd->EditValue = explode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->location_2nd->AdvancedSearch->SearchValue);
            }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fextra_stocklist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fextra_stocksrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
