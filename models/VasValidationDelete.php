 ...
 * Page class
 */
class VasValidationDelete extends VasValidation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VasValidationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("vasvalidationlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("vasvalidationlist"); // Return to list
                return;
            }
        }
