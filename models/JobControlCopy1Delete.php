 ...
 * Page class
 */
class JobControlCopy1Delete extends JobControlCopy1
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JobControlCopy1Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jobcontrolcopy1list"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jobcontrolcopy1list"); // Return to list
                return;
            }
        }
