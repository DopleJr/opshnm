 ...
 * Page class
 */
class EmptyBoxView extends EmptyBox
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmptyBoxView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "emptyboxlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "emptyboxlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "emptyboxlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    public function loadRowValues($rs = null)
    {
        ...
        $this->photo_before->setDbValue($row['photo_before']);
        $this->photo_after->setDbValue($row['photo_after']);
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // photo_before
            $this->photo_before->ViewValue = $this->photo_before->CurrentValue;
            $this->photo_before->ViewCustomAttributes = "";

            // photo_after
            $this->photo_after->ViewValue = $this->photo_after->CurrentValue;
