 ...
 * Page class
 */
class TransferBinPieceAdd extends TransferBinPiece
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransferBinPieceAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("transferbinpiecelist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "transferbinpiecelist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "transferbinpieceview") {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->date_confirmation->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->date_confirmation->setFormValue($val, true, $validate);
            }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // source_location
        $this->source_location->setDbValueDef($rsnew, $this->source_location->CurrentValue, null, false);
        ...
        // destination_location
        $this->destination_location->setDbValueDef($rsnew, $this->destination_location->CurrentValue, null, false);
        ...
        // date_confirmation
        $this->date_confirmation->setDbValueDef($rsnew, UnFormatDateTime($this->date_confirmation->CurrentValue, $this->date_confirmation->formatPattern()), null, false);

        // time_confirmation
        $this->time_confirmation->setDbValueDef($rsnew, UnFormatDateTime($this->time_confirmation->CurrentValue, $this->time_confirmation->formatPattern()), null, false);
