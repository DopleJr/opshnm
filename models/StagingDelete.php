 ...
 * Page class
 */
class StagingDelete extends Staging
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StagingDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("staginglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("staginglist"); // Return to list
                return;
            }
        }
