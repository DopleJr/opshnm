 ...
 * Page class
 */
class AuditPickingOnlineDelete extends AuditPickingOnline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AuditPickingOnlineDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("auditpickingonlinelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("auditpickingonlinelist"); // Return to list
                return;
            }
        }
    ...
    public function loadRowValues($rs = null)
    {
        ...
        $this->total_qty->setDbValue($row['total_qty']);
    ...
    protected function newRow()
    {
        ...
        $row['total_qty'] = $this->total_qty->DefaultValue;
    ...
    public function renderRow()
    {
        ...
        // total_qty
        $this->total_qty->CellCssStyle = "white-space: nowrap;";
