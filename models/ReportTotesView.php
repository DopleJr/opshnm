 ...
 * Page class
 */
class ReportTotesView extends ReportTotes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReportTotesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "reporttoteslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "reporttoteslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "reporttoteslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
