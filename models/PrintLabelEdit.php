 ...
 * Page class
 */
class PrintLabelEdit extends PrintLabel
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PrintLabelEdit";
    ...
    public function run()
    {
        ...
        $this->box_id->Required = false;
        $this->user->Required = false;
        $this->date_created->Required = false;
        $this->time_created->Required = false;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("printlabellist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "printlabellist") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->box_id->EditCustomAttributes = 'readonly';
            $this->box_id->EditValue = $this->box_id->CurrentValue;
            $this->box_id->ViewCustomAttributes = "";

            // priority
            $this->priority->EditCustomAttributes = "";
            $this->priority->EditValue = $this->priority->options(false);
            ...
            if ($this->store_code->ViewValue !== null) { // Load from cache
                ...
                if ($curVal == "") {
                    ...
                    $filterWrk = "`store_code`" . SearchString("=", $this->store_code->CurrentValue, DATATYPE_STRING, "");
                }
    ...
    protected function editRow()
    {
        ...
        // store_code
        $this->store_code->setDbValueDef($rsnew, $this->store_code->CurrentValue, "", $this->store_code->ReadOnly);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("printlabellist"), "", $this->TableVar, true);
        $pageId = "edit";
