...
/**
 * Table class for monitor_cycle_count_offline
 */
class MonitorCycleCountOffline extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'monitor_cycle_count_offline';
        $this->TableName = 'monitor_cycle_count_offline';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`monitor_cycle_count_offline`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Date Created
        $this->DateCreated = new DbField(
            'monitor_cycle_count_offline',
            'monitor_cycle_count_offline',
            'x_DateCreated',
            'Date Created',
            '`Date Created`',
            CastDateFieldForLike("`Date Created`", 0, "DB"),
            133,
            10,
            0,
            false,
        ...
        $this->DateCreated->AdvancedSearch->SearchOperatorDefault = "BETWEEN";
        $this->DateCreated->AdvancedSearch->SearchOperatorDefault2 = "";
        $this->DateCreated->AdvancedSearch->SearchConditionDefault = "AND";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`monitor_cycle_count_offline`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->ShortArticle->DbValue = $row['Short Article'];
        $this->Total->DbValue = $row['Total'];
        $this->User->DbValue = $row['User'];
        $this->DateCreated->DbValue = $row['Date Created'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("monitorcyclecountofflinelist");
    }
    ...
    {
        global $Language;
        if ($pageName == "monitorcyclecountofflineview") {
            return $Language->phrase("View");
        } elseif ($pageName == "monitorcyclecountofflineedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "monitorcyclecountofflineadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MonitorCycleCountOfflineView";
            case Config("API_ADD_ACTION"):
                return "MonitorCycleCountOfflineAdd";
            case Config("API_EDIT_ACTION"):
                return "MonitorCycleCountOfflineEdit";
            case Config("API_DELETE_ACTION"):
                return "MonitorCycleCountOfflineDelete";
            case Config("API_LIST_ACTION"):
                return "MonitorCycleCountOfflineList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("monitorcyclecountofflineview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("monitorcyclecountofflineview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "monitorcyclecountofflineadd?" . $this->getUrlParm($parm);
        } else {
            $url = "monitorcyclecountofflineadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("monitorcyclecountofflineedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("monitorcyclecountofflineadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("monitorcyclecountofflinedelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        // Short Article
        $this->ShortArticle->setupEditAttributes();
        $this->ShortArticle->EditCustomAttributes = "";
        if (!$this->ShortArticle->Raw) {
            $this->ShortArticle->CurrentValue = HtmlDecode($this->ShortArticle->CurrentValue);
        }
        $this->ShortArticle->EditValue = $this->ShortArticle->CurrentValue;
        $this->ShortArticle->PlaceHolder = RemoveHtml($this->ShortArticle->caption());
        ...
        $this->DateCreated->EditValue = FormatDateTime($this->DateCreated->CurrentValue, $this->DateCreated->formatPattern());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->ShortArticle);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->ShortArticle);
