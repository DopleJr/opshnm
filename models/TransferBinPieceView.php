 ...
 * Page class
 */
class TransferBinPieceView extends TransferBinPiece
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransferBinPieceView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "transferbinpiecelist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "transferbinpiecelist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "transferbinpiecelist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
