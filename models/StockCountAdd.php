 ...
 * Page class
 */
class StockCountAdd extends StockCount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockCountAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "stockcountview") {
    ...
    {
        $this->location->DefaultValue = GetStockLocation();
        ...
        $this->get_total->DefaultValue = GetStockRecord();
