 ...
 * Page class
 */
class PutawayStaging2Edit extends PutawayStaging2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PutawayStaging2Edit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("putawaystaging2list"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "putawaystaging2list") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("putawaystaging2list"), "", $this->TableVar, true);
        $pageId = "edit";
