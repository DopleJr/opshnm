 ...
 * Page class
 */
class LocationsAdd extends Locations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LocationsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("locationslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "locationslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "locationsview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // sequence
        $this->sequence->setDbValueDef($rsnew, $this->sequence->CurrentValue, null, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("locationslist"), "", $this->TableVar, true);
