 ...
 * Page class
 */
class MasterArticleEdit extends MasterArticle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterArticleEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("masterarticlelist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "masterarticlelist") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("masterarticlelist"), "", $this->TableVar, true);
        $pageId = "edit";
