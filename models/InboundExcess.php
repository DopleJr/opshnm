...
/**
 * Table class for inbound_excess
 */
class InboundExcess extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'inbound_excess';
        $this->TableName = 'inbound_excess';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`inbound_excess`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // total_scanned
        $this->total_scanned = new DbField(
            'inbound_excess',
            'inbound_excess',
            'x_total_scanned',
            'total_scanned',
        ...
        $this->total_scanned->InputTextType = "text";
        $this->total_scanned->IsCustom = true; // Custom field
        $this->total_scanned->Sortable = false; // Allow sort
        $this->Fields['total_scanned'] = &$this->total_scanned;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->sscc->Lookup = new Lookup('sscc', 'inbound_excess', true, 'sscc', ["sscc","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->sscc->Lookup = new Lookup('sscc', 'inbound_excess', true, 'sscc', ["sscc","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->pallet_id->InputTextType = "text";
        $this->pallet_id->Nullable = false; // NOT NULL field
        $this->pallet_id->Required = true; // Required field
        $this->pallet_id->UseFilter = true; // Table header filter
        switch ($CurrentLanguage) {
            case "en-US":
                $this->pallet_id->Lookup = new Lookup('pallet_id', 'inbound_excess', true, 'pallet_id', ["pallet_id","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->pallet_id->Lookup = new Lookup('pallet_id', 'inbound_excess', true, 'pallet_id', ["pallet_id","","",""], [], [], [], [], [], [], '', '', "");
                break;
        }
        $this->Fields['pallet_id'] = &$this->pallet_id;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->users->Lookup = new Lookup('users', 'inbound_excess', true, 'users', ["users","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->users->Lookup = new Lookup('users', 'inbound_excess', true, 'users', ["users","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->date_update->Lookup = new Lookup('date_update', 'inbound_excess', true, 'date_update', ["date_update","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->date_update->Lookup = new Lookup('date_update', 'inbound_excess', true, 'date_update', ["date_update","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->time_update = new DbField(
            ...
            'time_update',
            '`time_update`',
            CastDateFieldForLike("`time_update`", 4, "DB"),
            134,
            10,
            4,
            false,
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->time_update->Lookup = new Lookup('time_update', 'inbound_excess', true, 'time_update', ["time_update","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->time_update->Lookup = new Lookup('time_update', 'inbound_excess', true, 'time_update', ["time_update","","",""], [], [], [], [], [], [], '', '', "");
                break;
        }
        $this->time_update->DefaultErrorMessage = str_replace("%s", DateFormat(4), $Language->phrase("IncorrectTime"));
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`inbound_excess`";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS `total_scanned`");
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->total_scanned->DbValue = $row['total_scanned'];
        $this->sscc->DbValue = $row['sscc'];
        $this->pallet_id->DbValue = $row['pallet_id'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("inboundexcesslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "inboundexcessedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "inboundexcessadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "InboundExcessView";
            case Config("API_ADD_ACTION"):
                return "InboundExcessAdd";
            case Config("API_EDIT_ACTION"):
                return "InboundExcessEdit";
            case Config("API_DELETE_ACTION"):
                return "InboundExcessDelete";
            case Config("API_LIST_ACTION"):
                return "InboundExcessList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("inboundexcessview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("inboundexcessview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "inboundexcessadd?" . $this->getUrlParm($parm);
        } else {
            $url = "inboundexcessadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("inboundexcessedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("inboundexcessadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("inboundexcessdelete", $this->getUrlParm());
    }
    ...
    public function renderListRow()
    {
        ...
        $this->total_scanned->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->total_scanned->EditValue = $this->total_scanned->CurrentValue;
        ...
        $this->pallet_id->EditValue = $this->pallet_id->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->pallet_id);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->pallet_id);
