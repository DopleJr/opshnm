 ...
 * Page class
 */
class MasterArticleDelete extends MasterArticle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterArticleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("masterarticlelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("masterarticlelist"); // Return to list
                return;
            }
        }
