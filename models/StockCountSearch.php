 ...
 * Page class
 */
class StockCountSearch extends StockCount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StockCountSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "stockcountlist" . "?" . $srchStr;
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->time_created); // time_created
        $this->buildSearchUrl($srchUrl, $this->get_total); // get_total
        if ($srchUrl != "") {
            $srchUrl .= "&";
        }
        $srchUrl .= "cmd=search";
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->time_created->EditCustomAttributes = "";
            $this->time_created->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->time_created->AdvancedSearch->SearchValue, $this->time_created->formatPattern()), $this->time_created->formatPattern()));
            ...
            if (!$this->get_total->Raw) {
                $this->get_total->AdvancedSearch->SearchValue = HtmlDecode($this->get_total->AdvancedSearch->SearchValue);
            }
            $this->get_total->EditValue = HtmlEncode($this->get_total->AdvancedSearch->SearchValue);
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckTime($this->time_created->AdvancedSearch->SearchValue, $this->time_created->formatPattern())) {
