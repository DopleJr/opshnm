...
/**
 * Table class for price_tag
 */
class PriceTag extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'price_tag';
        $this->TableName = 'price_tag';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`price_tag`";
        $this->Dbid = 'DB';
        ...
        $this->id->Lookup = new Lookup('id', 'price_tag', true, 'id', ["id","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->location->Lookup = new Lookup('location', 'price_tag', true, 'location', ["location","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->ctn->Lookup = new Lookup('ctn', 'price_tag', true, 'ctn', ["ctn","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->article->Lookup = new Lookup('article', 'price_tag', true, 'article', ["article","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->description->Lookup = new Lookup('description', 'price_tag', true, 'description', ["description","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->size_desc->Lookup = new Lookup('size_desc', 'price_tag', true, 'size_desc', ["size_desc","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->color_code->Lookup = new Lookup('color_code', 'price_tag', true, 'color_code', ["color_code","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->color_desc->Lookup = new Lookup('color_desc', 'price_tag', true, 'color_desc', ["color_desc","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->season->Lookup = new Lookup('season', 'price_tag', true, 'season', ["season","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->quantity->Lookup = new Lookup('quantity', 'price_tag', true, 'quantity', ["quantity","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->user->Lookup = new Lookup('user', 'price_tag', true, 'user', ["user","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->date_created->Lookup = new Lookup('date_created', 'price_tag', true, 'date_created', ["date_created","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->date_updated->Lookup = new Lookup('date_updated', 'price_tag', true, 'date_updated', ["date_updated","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`price_tag`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("pricetaglist");
    }
    ...
    {
        global $Language;
        if ($pageName == "pricetagview") {
            return $Language->phrase("View");
        } elseif ($pageName == "pricetagedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "pricetagadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("pricetagview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("pricetagview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "pricetagadd?" . $this->getUrlParm($parm);
        } else {
            $url = "pricetagadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("pricetagedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pricetagadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("pricetagdelete", $this->getUrlParm());
    }
    ...
    public function rowInserting($rsold, &$rsnew)
    {
        ...
        //Pre-Insert Price Tag
        	...
        	$_gtin2  = $rsnew["gtin2"];
        	$_gtin3  = $rsnew["gtin3"];
            $compare1 = "SELECT count(`article`) FROM master_article WHERE  `gtin` =  '$_gtin' OR `gtin` =  '$_gtin2' OR `gtin` =  '$_gtin3' ";
    ...
    public function rowInserted($rsold, &$rsnew)
    {
        //Log("Row Inserted");
            ...
            $article = "SELECT `article` FROM `master_article` WHERE `gtin` =  '$_gtin' OR `gtin` =  '$_gtin2' OR `gtin` =  '$_gtin3'  ";
            $_article1 = ExecuteScalar($article);
            $size_desc = "SELECT `size_desc` FROM `master_article` WHERE `gtin` =  '$_gtin' OR `gtin` =  '$_gtin2' OR `gtin` =  '$_gtin3'  ";
            $_size_desc = ExecuteScalar($size_desc);
            $color_desc = "SELECT `color_desc` FROM `master_article` WHERE `gtin` =  '$_gtin' OR `gtin` =  '$_gtin2' OR `gtin` =  '$_gtin3' ";
            $_color_desc = ExecuteScalar($color_desc);
            $color_code = "SELECT `color_code` FROM `master_article` WHERE `gtin` =  '$_gtin' OR `gtin` =  '$_gtin2' OR `gtin` =  '$_gtin3'  ";
            $_color_code = ExecuteScalar($color_code);
            $season = "SELECT `season` FROM `master_article` WHERE `gtin` =  '$_gtin' OR `gtin` =  '$_gtin2' OR `gtin` =  '$_gtin3'  ";
            $_season = ExecuteScalar($season);
            $description = "SELECT `description` FROM `master_article` WHERE `gtin` =  '$_gtin' OR `gtin` =  '$_gtin2' OR `gtin` =  '$_gtin3'  ";
            ...
            //$size_desc_ = "SELECT `size_desc` FROM `master_article` WHERE `article` =  '$_article2' ";
            //$_size_desc_ = ExecuteScalar($size_desc_);
            //$color_desc_ = "SELECT `color_desc` FROM `master_article` WHERE `article` =  '$_article2' ";
            //$_color_desc_ = ExecuteScalar($color_desc_);
            //$color_code_ = "SELECT `color_code` FROM `master_article` WHERE `article` =  '$_article2' ";
            //$_color_code_ = ExecuteScalar($color_code_);
            //$season_ = "SELECT `season` FROM `master_article` WHERE `article` =  '$_article2' ";
            //$_season_ = ExecuteScalar($season_);
            //$description_ = "SELECT `description` FROM `master_article` WHERE `article` =  '$_article2' ";
            ...
            //$result_true1_ = "UPDATE extra_stock SET `quantity` = ( `quantity` + '1'), `date_updated` = '$currentDateTime'  WHERE `article` = '$_article2' AND `location` =  '$_location' AND `ctn` =  '$_ctn' ";
             //$result_false1  = "DELETE FROM extra_stock WHERE  id = '$_id' ";
            //$result_false2_ = "INSERT INTO `extra_stock`(id,article,location,ctn,quantity,description,size_desc,color_code,color_desc,season,date_created,date_updated) VALUES (0,'$_article2','$_location','$_ctn','1','$_description','$_size_desc','$_color_code','$_color_desc','$_season','$currentDate','$currentDateTime')";
            ...
            //console.log('statement2');
            	...
            	//ExecuteStatement($result_false1);
