...
/**
 * Table class for master_article2
 */
class MasterArticle2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'master_article2';
        $this->TableName = 'master_article2';
        ...
        $this->article->Lookup = new Lookup('article', 'master_article2', true, 'article', ["article","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->description->Lookup = new Lookup('description', 'master_article2', true, 'description', ["description","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->gtin->Lookup = new Lookup('gtin', 'master_article2', true, 'gtin', ["gtin","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->color_code->Lookup = new Lookup('color_code', 'master_article2', true, 'color_code', ["color_code","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->color_desc->Lookup = new Lookup('color_desc', 'master_article2', true, 'color_desc', ["color_desc","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->size_code->Lookup = new Lookup('size_code', 'master_article2', true, 'size_code', ["size_code","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->size_desc->Lookup = new Lookup('size_desc', 'master_article2', true, 'size_desc', ["size_desc","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->season->Lookup = new Lookup('season', 'master_article2', true, 'season', ["season","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->price->Lookup = new Lookup('price', 'master_article2', true, 'price', ["price","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`master_article2`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("masterarticle2list");
    }
    ...
    {
        global $Language;
        if ($pageName == "masterarticle2view") {
            return $Language->phrase("View");
        } elseif ($pageName == "masterarticle2edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "masterarticle2add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MasterArticle2View";
            case Config("API_ADD_ACTION"):
                return "MasterArticle2Add";
            case Config("API_EDIT_ACTION"):
                return "MasterArticle2Edit";
            case Config("API_DELETE_ACTION"):
                return "MasterArticle2Delete";
            case Config("API_LIST_ACTION"):
                return "MasterArticle2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("masterarticle2view", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("masterarticle2view", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "masterarticle2add?" . $this->getUrlParm($parm);
        } else {
            $url = "masterarticle2add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("masterarticle2edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("masterarticle2add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("masterarticle2delete", $this->getUrlParm());
    }
