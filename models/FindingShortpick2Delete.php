 ...
 * Page class
 */
class FindingShortpick2Delete extends FindingShortpick2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FindingShortpick2Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("findingshortpick2list"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("findingshortpick2list"); // Return to list
                return;
            }
        }
