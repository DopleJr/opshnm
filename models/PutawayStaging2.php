...
/**
 * Table class for putaway_staging2
 */
class PutawayStaging2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'putaway_staging2';
        $this->TableName = 'putaway_staging2';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`putaway_staging2`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`putaway_staging2`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("putawaystaging2list");
    }
    ...
    {
        global $Language;
        if ($pageName == "putawaystaging2view") {
            return $Language->phrase("View");
        } elseif ($pageName == "putawaystaging2edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "putawaystaging2add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PutawayStaging2View";
            case Config("API_ADD_ACTION"):
                return "PutawayStaging2Add";
            case Config("API_EDIT_ACTION"):
                return "PutawayStaging2Edit";
            case Config("API_DELETE_ACTION"):
                return "PutawayStaging2Delete";
            case Config("API_LIST_ACTION"):
                return "PutawayStaging2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("putawaystaging2view", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("putawaystaging2view", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "putawaystaging2add?" . $this->getUrlParm($parm);
        } else {
            $url = "putawaystaging2add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawaystaging2edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawaystaging2add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("putawaystaging2delete", $this->getUrlParm());
    }
