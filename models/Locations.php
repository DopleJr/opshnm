...
class Locations extends DbTable
{
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("locationsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("locationsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "locationsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "locationsadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("locationsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("locationsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("locationsdelete", $this->getUrlParm());
    }
