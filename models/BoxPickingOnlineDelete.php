 ...
 * Page class
 */
class BoxPickingOnlineDelete extends BoxPickingOnline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BoxPickingOnlineDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("boxpickingonlinelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("boxpickingonlinelist"); // Return to list
                return;
            }
        }
