...
/**
 * Table class for strapi_core_store_settings
 */
class StrapiCoreStoreSettings extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'strapi_core_store_settings';
        $this->TableName = 'strapi_core_store_settings';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`strapi_core_store_settings`";
        $this->Dbid = 'DB';
        ...
        $this->environment->InputTextType = "text";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`strapi_core_store_settings`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("strapicorestoresettingslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "strapicorestoresettingsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "strapicorestoresettingsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "strapicorestoresettingsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "StrapiCoreStoreSettingsView";
            case Config("API_ADD_ACTION"):
                return "StrapiCoreStoreSettingsAdd";
            case Config("API_EDIT_ACTION"):
                return "StrapiCoreStoreSettingsEdit";
            case Config("API_DELETE_ACTION"):
                return "StrapiCoreStoreSettingsDelete";
            case Config("API_LIST_ACTION"):
                return "StrapiCoreStoreSettingsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("strapicorestoresettingsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("strapicorestoresettingsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "strapicorestoresettingsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "strapicorestoresettingsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("strapicorestoresettingsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("strapicorestoresettingsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("strapicorestoresettingsdelete", $this->getUrlParm());
    }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->environment->setDbValue($row['environment']);
    ...
    public function renderEditRow()
    {
        ...
        // environment
        $this->environment->setupEditAttributes();
        $this->environment->EditCustomAttributes = "";
        if (!$this->environment->Raw) {
            $this->environment->CurrentValue = HtmlDecode($this->environment->CurrentValue);
        }
        $this->environment->EditValue = $this->environment->CurrentValue;
        $this->environment->PlaceHolder = RemoveHtml($this->environment->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->environment);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->environment);
