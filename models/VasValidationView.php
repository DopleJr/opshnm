 ...
 * Page class
 */
class VasValidationView extends VasValidation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VasValidationView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "vasvalidationlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "vasvalidationlist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "vasvalidationlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
