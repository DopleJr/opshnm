 ...
 * Page class
 */
class JobControlCopy1View extends JobControlCopy1
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JobControlCopy1View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "jobcontrolcopy1list"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "jobcontrolcopy1list"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "jobcontrolcopy1list"; // Not page request, return to list
        }
        if ($returnUrl != "") {
