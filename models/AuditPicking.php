...
/**
 * Table class for audit_picking
 */
class AuditPicking extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'audit_picking';
        $this->TableName = 'audit_picking';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`audit_picking`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`audit_picking`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("auditpickinglist");
    }
    ...
    {
        global $Language;
        if ($pageName == "auditpickingview") {
            return $Language->phrase("View");
        } elseif ($pageName == "auditpickingedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "auditpickingadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AuditPickingView";
            case Config("API_ADD_ACTION"):
                return "AuditPickingAdd";
            case Config("API_EDIT_ACTION"):
                return "AuditPickingEdit";
            case Config("API_DELETE_ACTION"):
                return "AuditPickingDelete";
            case Config("API_LIST_ACTION"):
                return "AuditPickingList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("auditpickingview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("auditpickingview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "auditpickingadd?" . $this->getUrlParm($parm);
        } else {
            $url = "auditpickingadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("auditpickingedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("auditpickingadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("auditpickingdelete", $this->getUrlParm());
    }
