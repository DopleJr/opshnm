...
/**
 * Table class for putaway_staging5
 */
class PutawayStaging5 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'putaway_staging5';
        $this->TableName = 'putaway_staging5';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`putaway_staging5`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`putaway_staging5`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("putawaystaging5list");
    }
    ...
    {
        global $Language;
        if ($pageName == "putawaystaging5view") {
            return $Language->phrase("View");
        } elseif ($pageName == "putawaystaging5edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "putawaystaging5add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PutawayStaging5View";
            case Config("API_ADD_ACTION"):
                return "PutawayStaging5Add";
            case Config("API_EDIT_ACTION"):
                return "PutawayStaging5Edit";
            case Config("API_DELETE_ACTION"):
                return "PutawayStaging5Delete";
            case Config("API_LIST_ACTION"):
                return "PutawayStaging5List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("putawaystaging5view", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("putawaystaging5view", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "putawaystaging5add?" . $this->getUrlParm($parm);
        } else {
            $url = "putawaystaging5add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawaystaging5edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawaystaging5add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("putawaystaging5delete", $this->getUrlParm());
    }
