 ...
 * Page class
 */
class BoxPickingOnlineAdd extends BoxPickingOnline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BoxPickingOnlineAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "boxpickingonlineview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // scan_qty
        $this->scan_qty->setDbValueDef($rsnew, $this->scan_qty->CurrentValue, null, false);
        ...
        // date_staging
        $this->date_staging->setDbValueDef($rsnew, UnFormatDateTime($this->date_staging->CurrentValue, $this->date_staging->formatPattern()), null, false);
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['box_id']) == "") {
