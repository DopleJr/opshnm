 ...
 * Page class
 */
class BlankCountSheetDelete extends BlankCountSheet
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BlankCountSheetDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("blankcountsheetlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("blankcountsheetlist"); // Return to list
                return;
            }
        }
