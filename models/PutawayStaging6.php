...
/**
 * Table class for putaway_staging6
 */
class PutawayStaging6 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'putaway_staging6';
        $this->TableName = 'putaway_staging6';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`putaway_staging6`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`putaway_staging6`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("putawaystaging6list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "putawaystaging6edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "putawaystaging6add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PutawayStaging6View";
            case Config("API_ADD_ACTION"):
                return "PutawayStaging6Add";
            case Config("API_EDIT_ACTION"):
                return "PutawayStaging6Edit";
            case Config("API_DELETE_ACTION"):
                return "PutawayStaging6Delete";
            case Config("API_LIST_ACTION"):
                return "PutawayStaging6List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("putawaystaging6view", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("putawaystaging6view", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "putawaystaging6add?" . $this->getUrlParm($parm);
        } else {
            $url = "putawaystaging6add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawaystaging6edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("putawaystaging6add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("putawaystaging6delete", $this->getUrlParm());
    }
