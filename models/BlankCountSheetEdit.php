 ...
 * Page class
 */
class BlankCountSheetEdit extends BlankCountSheet
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BlankCountSheetEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("blankcountsheetlist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "blankcountsheetlist") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("blankcountsheetlist"), "", $this->TableVar, true);
        $pageId = "edit";
