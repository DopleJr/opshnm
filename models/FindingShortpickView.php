 ...
 * Page class
 */
class FindingShortpickView extends FindingShortpick
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FindingShortpickView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "findingshortpicklist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "findingshortpicklist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "findingshortpicklist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
