 ...
 * Page class
 */
class JobControlAdd extends JobControl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JobControlAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "jobcontrolview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // job_category
        $this->job_category->setDbValueDef($rsnew, $this->job_category->CurrentValue, null, false);
        ...
        // test
        $this->test->setDbValueDef($rsnew, $this->test->CurrentValue, null, false);
