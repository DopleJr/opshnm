...
/**
 * Table class for audit staging
 */
class Auditstaging extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'auditstaging';
        $this->TableName = 'audit staging';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`audit staging`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`audit staging`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("auditstaginglist");
    }
    ...
    {
        global $Language;
        if ($pageName == "auditstagingview") {
            return $Language->phrase("View");
        } elseif ($pageName == "auditstagingedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "auditstagingadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AuditstagingView";
            case Config("API_ADD_ACTION"):
                return "AuditstagingAdd";
            case Config("API_EDIT_ACTION"):
                return "AuditstagingEdit";
            case Config("API_DELETE_ACTION"):
                return "AuditstagingDelete";
            case Config("API_LIST_ACTION"):
                return "AuditstagingList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("auditstagingview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("auditstagingview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "auditstagingadd?" . $this->getUrlParm($parm);
        } else {
            $url = "auditstagingadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("auditstagingedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("auditstagingadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("auditstagingdelete", $this->getUrlParm());
    }
