 ...
 * Page class
 */
class StagingView extends Staging
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StagingView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "staginglist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "staginglist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "staginglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
