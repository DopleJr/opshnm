 ...
 * Page class
 */
class ExtraStockDelete extends ExtraStock
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ExtraStockDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("extrastocklist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("extrastocklist"); // Return to list
                return;
            }
        }
