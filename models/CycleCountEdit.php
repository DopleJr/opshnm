 ...
 * Page class
 */
class CycleCountEdit extends CycleCount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CycleCountEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("cyclecountlist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "cyclecountlist") {
    ...
    protected function editRow()
    {
        ...
        // scan
        $this->scan->setDbValueDef($rsnew, $this->scan->CurrentValue, null, $this->scan->ReadOnly);
