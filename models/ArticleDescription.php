...
/**
 * Table class for article_description
 */
class ArticleDescription extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'article_description';
        $this->TableName = 'article_description';
        $this->TableType = 'VIEW';
        ...
        $this->article->Lookup = new Lookup('article', 'article_description', true, 'article', ["article","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->description->Lookup = new Lookup('description', 'article_description', true, 'description', ["description","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->color_code->Lookup = new Lookup('color_code', 'article_description', true, 'color_code', ["color_code","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->color_desc->Lookup = new Lookup('color_desc', 'article_description', true, 'color_desc', ["color_desc","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->size_desc->Lookup = new Lookup('size_desc', 'article_description', true, 'size_desc', ["size_desc","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->size_code->Lookup = new Lookup('size_code', 'article_description', true, 'size_code', ["size_code","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->season->Lookup = new Lookup('season', 'article_description', true, 'season', ["season","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`article_description`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("articledescriptionlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "articledescriptionview") {
            return $Language->phrase("View");
        } elseif ($pageName == "articledescriptionedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "articledescriptionadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "ArticleDescriptionAdd";
            case Config("API_EDIT_ACTION"):
                return "ArticleDescriptionEdit";
            case Config("API_DELETE_ACTION"):
                return "ArticleDescriptionDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("articledescriptionview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("articledescriptionview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "articledescriptionadd?" . $this->getUrlParm($parm);
        } else {
            $url = "articledescriptionadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("articledescriptionedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("articledescriptionadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("articledescriptiondelete", $this->getUrlParm());
    }
