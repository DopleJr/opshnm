...
/**
 * Table class for up_permissions
 */
class UpPermissions extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'up_permissions';
        $this->TableName = 'up_permissions';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`up_permissions`";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`up_permissions`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("uppermissionslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "uppermissionsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "uppermissionsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "uppermissionsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UpPermissionsView";
            case Config("API_ADD_ACTION"):
                return "UpPermissionsAdd";
            case Config("API_EDIT_ACTION"):
                return "UpPermissionsEdit";
            case Config("API_DELETE_ACTION"):
                return "UpPermissionsDelete";
            case Config("API_LIST_ACTION"):
                return "UpPermissionsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("uppermissionsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("uppermissionsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "uppermissionsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "uppermissionsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("uppermissionsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("uppermissionsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("uppermissionsdelete", $this->getUrlParm());
    }
