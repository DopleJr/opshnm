 ...
 * Page class
 */
class PickingView extends Picking
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PickingView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "pickinglist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "pickinglist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "pickinglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
