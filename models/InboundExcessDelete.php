 ...
 * Page class
 */
class InboundExcessDelete extends InboundExcess
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InboundExcessDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("inboundexcesslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("inboundexcesslist"); // Return to list
                return;
            }
        }
