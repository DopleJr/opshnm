 ...
 * Page class
 */
class PutawayStaging5Edit extends PutawayStaging5
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PutawayStaging5Edit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("putawaystaging5list"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "putawaystaging5list") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("putawaystaging5list"), "", $this->TableVar, true);
        $pageId = "edit";
