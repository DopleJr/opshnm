 ...
 * Page class
 */
class BoxPickingView extends BoxPicking
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BoxPickingView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "boxpickinglist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "boxpickinglist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "boxpickinglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
