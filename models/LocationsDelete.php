 ...
 * Page class
 */
class LocationsDelete extends Locations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LocationsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("locationslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("locationslist"); // Return to list
                return;
            }
        }
