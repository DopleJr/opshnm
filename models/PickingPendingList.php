 ...
 * Page class
 */
class PickingPendingList extends PickingPending
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PickingPendingList";
    ...
    public $FormName = "fpicking_pendinglist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "pickingpendingadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "pickingpendingdelete";
        $this->MultiUpdateUrl = "pickingpendingupdate";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->to_no->AdvancedSearch->toJson(), ","); // Field to_no
        $filterList = Concat($filterList, $this->to_order_item->AdvancedSearch->toJson(), ","); // Field to_order_item
        $filterList = Concat($filterList, $this->to_priority->AdvancedSearch->toJson(), ","); // Field to_priority
        $filterList = Concat($filterList, $this->to_priority_code->AdvancedSearch->toJson(), ","); // Field to_priority_code
        $filterList = Concat($filterList, $this->source_storage_type->AdvancedSearch->toJson(), ","); // Field source_storage_type
        $filterList = Concat($filterList, $this->source_storage_bin->AdvancedSearch->toJson(), ","); // Field source_storage_bin
        $filterList = Concat($filterList, $this->carton_number->AdvancedSearch->toJson(), ","); // Field carton_number
        $filterList = Concat($filterList, $this->creation_date->AdvancedSearch->toJson(), ","); // Field creation_date
        $filterList = Concat($filterList, $this->gr_number->AdvancedSearch->toJson(), ","); // Field gr_number
        $filterList = Concat($filterList, $this->gr_date->AdvancedSearch->toJson(), ","); // Field gr_date
        $filterList = Concat($filterList, $this->delivery->AdvancedSearch->toJson(), ","); // Field delivery
        ...
        $filterList = Concat($filterList, $this->size_code->AdvancedSearch->toJson(), ","); // Field size_code
        ...
        $filterList = Concat($filterList, $this->variance_qty->AdvancedSearch->toJson(), ","); // Field variance_qty
        $filterList = Concat($filterList, $this->confirmation_date->AdvancedSearch->toJson(), ","); // Field confirmation_date
        $filterList = Concat($filterList, $this->confirmation_time->AdvancedSearch->toJson(), ","); // Field confirmation_time
        $filterList = Concat($filterList, $this->box_code->AdvancedSearch->toJson(), ","); // Field box_code
        $filterList = Concat($filterList, $this->box_type->AdvancedSearch->toJson(), ","); // Field box_type
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpicking_pendingsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field to_no
        $this->to_no->AdvancedSearch->SearchValue = @$filter["x_to_no"];
        $this->to_no->AdvancedSearch->SearchOperator = @$filter["z_to_no"];
        $this->to_no->AdvancedSearch->SearchCondition = @$filter["v_to_no"];
        $this->to_no->AdvancedSearch->SearchValue2 = @$filter["y_to_no"];
        $this->to_no->AdvancedSearch->SearchOperator2 = @$filter["w_to_no"];
        $this->to_no->AdvancedSearch->save();

        // Field to_order_item
        $this->to_order_item->AdvancedSearch->SearchValue = @$filter["x_to_order_item"];
        $this->to_order_item->AdvancedSearch->SearchOperator = @$filter["z_to_order_item"];
        $this->to_order_item->AdvancedSearch->SearchCondition = @$filter["v_to_order_item"];
        $this->to_order_item->AdvancedSearch->SearchValue2 = @$filter["y_to_order_item"];
        $this->to_order_item->AdvancedSearch->SearchOperator2 = @$filter["w_to_order_item"];
        $this->to_order_item->AdvancedSearch->save();

        // Field to_priority
        $this->to_priority->AdvancedSearch->SearchValue = @$filter["x_to_priority"];
        $this->to_priority->AdvancedSearch->SearchOperator = @$filter["z_to_priority"];
        $this->to_priority->AdvancedSearch->SearchCondition = @$filter["v_to_priority"];
        $this->to_priority->AdvancedSearch->SearchValue2 = @$filter["y_to_priority"];
        $this->to_priority->AdvancedSearch->SearchOperator2 = @$filter["w_to_priority"];
        $this->to_priority->AdvancedSearch->save();

        // Field to_priority_code
        $this->to_priority_code->AdvancedSearch->SearchValue = @$filter["x_to_priority_code"];
        $this->to_priority_code->AdvancedSearch->SearchOperator = @$filter["z_to_priority_code"];
        $this->to_priority_code->AdvancedSearch->SearchCondition = @$filter["v_to_priority_code"];
        $this->to_priority_code->AdvancedSearch->SearchValue2 = @$filter["y_to_priority_code"];
        $this->to_priority_code->AdvancedSearch->SearchOperator2 = @$filter["w_to_priority_code"];
        $this->to_priority_code->AdvancedSearch->save();

        // Field source_storage_type
        $this->source_storage_type->AdvancedSearch->SearchValue = @$filter["x_source_storage_type"];
        $this->source_storage_type->AdvancedSearch->SearchOperator = @$filter["z_source_storage_type"];
        $this->source_storage_type->AdvancedSearch->SearchCondition = @$filter["v_source_storage_type"];
        $this->source_storage_type->AdvancedSearch->SearchValue2 = @$filter["y_source_storage_type"];
        $this->source_storage_type->AdvancedSearch->SearchOperator2 = @$filter["w_source_storage_type"];
        $this->source_storage_type->AdvancedSearch->save();

        // Field source_storage_bin
        $this->source_storage_bin->AdvancedSearch->SearchValue = @$filter["x_source_storage_bin"];
        $this->source_storage_bin->AdvancedSearch->SearchOperator = @$filter["z_source_storage_bin"];
        $this->source_storage_bin->AdvancedSearch->SearchCondition = @$filter["v_source_storage_bin"];
        $this->source_storage_bin->AdvancedSearch->SearchValue2 = @$filter["y_source_storage_bin"];
        $this->source_storage_bin->AdvancedSearch->SearchOperator2 = @$filter["w_source_storage_bin"];
        $this->source_storage_bin->AdvancedSearch->save();

        // Field carton_number
        $this->carton_number->AdvancedSearch->SearchValue = @$filter["x_carton_number"];
        $this->carton_number->AdvancedSearch->SearchOperator = @$filter["z_carton_number"];
        $this->carton_number->AdvancedSearch->SearchCondition = @$filter["v_carton_number"];
        $this->carton_number->AdvancedSearch->SearchValue2 = @$filter["y_carton_number"];
        $this->carton_number->AdvancedSearch->SearchOperator2 = @$filter["w_carton_number"];
        $this->carton_number->AdvancedSearch->save();
        ...
        // Field gr_number
        $this->gr_number->AdvancedSearch->SearchValue = @$filter["x_gr_number"];
        $this->gr_number->AdvancedSearch->SearchOperator = @$filter["z_gr_number"];
        $this->gr_number->AdvancedSearch->SearchCondition = @$filter["v_gr_number"];
        $this->gr_number->AdvancedSearch->SearchValue2 = @$filter["y_gr_number"];
        $this->gr_number->AdvancedSearch->SearchOperator2 = @$filter["w_gr_number"];
        $this->gr_number->AdvancedSearch->save();

        // Field gr_date
        $this->gr_date->AdvancedSearch->SearchValue = @$filter["x_gr_date"];
        $this->gr_date->AdvancedSearch->SearchOperator = @$filter["z_gr_date"];
        $this->gr_date->AdvancedSearch->SearchCondition = @$filter["v_gr_date"];
        $this->gr_date->AdvancedSearch->SearchValue2 = @$filter["y_gr_date"];
        $this->gr_date->AdvancedSearch->SearchOperator2 = @$filter["w_gr_date"];
        $this->gr_date->AdvancedSearch->save();

        // Field delivery
        $this->delivery->AdvancedSearch->SearchValue = @$filter["x_delivery"];
        $this->delivery->AdvancedSearch->SearchOperator = @$filter["z_delivery"];
        $this->delivery->AdvancedSearch->SearchCondition = @$filter["v_delivery"];
        $this->delivery->AdvancedSearch->SearchValue2 = @$filter["y_delivery"];
        $this->delivery->AdvancedSearch->SearchOperator2 = @$filter["w_delivery"];
        $this->delivery->AdvancedSearch->save();
        ...
        // Field size_code
        $this->size_code->AdvancedSearch->SearchValue = @$filter["x_size_code"];
        $this->size_code->AdvancedSearch->SearchOperator = @$filter["z_size_code"];
        $this->size_code->AdvancedSearch->SearchCondition = @$filter["v_size_code"];
        $this->size_code->AdvancedSearch->SearchValue2 = @$filter["y_size_code"];
        $this->size_code->AdvancedSearch->SearchOperator2 = @$filter["w_size_code"];
        $this->size_code->AdvancedSearch->save();
        ...
        // Field variance_qty
        $this->variance_qty->AdvancedSearch->SearchValue = @$filter["x_variance_qty"];
        $this->variance_qty->AdvancedSearch->SearchOperator = @$filter["z_variance_qty"];
        $this->variance_qty->AdvancedSearch->SearchCondition = @$filter["v_variance_qty"];
        $this->variance_qty->AdvancedSearch->SearchValue2 = @$filter["y_variance_qty"];
        $this->variance_qty->AdvancedSearch->SearchOperator2 = @$filter["w_variance_qty"];
        $this->variance_qty->AdvancedSearch->save();
        ...
        $this->confirmation_time->AdvancedSearch->SearchValue = @$filter["x_confirmation_time"];
        $this->confirmation_time->AdvancedSearch->SearchOperator = @$filter["z_confirmation_time"];
        $this->confirmation_time->AdvancedSearch->SearchCondition = @$filter["v_confirmation_time"];
        $this->confirmation_time->AdvancedSearch->SearchValue2 = @$filter["y_confirmation_time"];
        $this->confirmation_time->AdvancedSearch->SearchOperator2 = @$filter["w_confirmation_time"];
        $this->confirmation_time->AdvancedSearch->save();
        ...
        // Field box_type
        $this->box_type->AdvancedSearch->SearchValue = @$filter["x_box_type"];
        $this->box_type->AdvancedSearch->SearchOperator = @$filter["z_box_type"];
        $this->box_type->AdvancedSearch->SearchCondition = @$filter["v_box_type"];
        $this->box_type->AdvancedSearch->SearchValue2 = @$filter["y_box_type"];
        $this->box_type->AdvancedSearch->SearchOperator2 = @$filter["w_box_type"];
        ...
        // Field aisle2
        $this->aisle2->AdvancedSearch->SearchValue = @$filter["x_aisle2"];
        $this->aisle2->AdvancedSearch->SearchOperator = @$filter["z_aisle2"];
        $this->aisle2->AdvancedSearch->SearchCondition = @$filter["v_aisle2"];
        $this->aisle2->AdvancedSearch->SearchValue2 = @$filter["y_aisle2"];
        $this->aisle2->AdvancedSearch->SearchOperator2 = @$filter["w_aisle2"];
        $this->aisle2->AdvancedSearch->save();

        // Field store_id2
        $this->store_id2->AdvancedSearch->SearchValue = @$filter["x_store_id2"];
        $this->store_id2->AdvancedSearch->SearchOperator = @$filter["z_store_id2"];
        $this->store_id2->AdvancedSearch->SearchCondition = @$filter["v_store_id2"];
        $this->store_id2->AdvancedSearch->SearchValue2 = @$filter["y_store_id2"];
        $this->store_id2->AdvancedSearch->SearchOperator2 = @$filter["w_store_id2"];
        $this->store_id2->AdvancedSearch->save();
        ...
        $this->close_totes->AdvancedSearch->SearchCondition = @$filter["v_close_totes"];
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->to_no, $default, false); // to_no
        $this->buildSearchSql($where, $this->to_order_item, $default, false); // to_order_item
        $this->buildSearchSql($where, $this->to_priority, $default, false); // to_priority
        $this->buildSearchSql($where, $this->to_priority_code, $default, false); // to_priority_code
        $this->buildSearchSql($where, $this->source_storage_type, $default, false); // source_storage_type
        $this->buildSearchSql($where, $this->source_storage_bin, $default, false); // source_storage_bin
        $this->buildSearchSql($where, $this->carton_number, $default, false); // carton_number
        $this->buildSearchSql($where, $this->creation_date, $default, false); // creation_date
        $this->buildSearchSql($where, $this->gr_number, $default, false); // gr_number
        $this->buildSearchSql($where, $this->gr_date, $default, false); // gr_date
        $this->buildSearchSql($where, $this->delivery, $default, false); // delivery
        $this->buildSearchSql($where, $this->store_id, $default, false); // store_id
        $this->buildSearchSql($where, $this->store_name, $default, false); // store_name
        $this->buildSearchSql($where, $this->article, $default, false); // article
        $this->buildSearchSql($where, $this->size_code, $default, false); // size_code
        $this->buildSearchSql($where, $this->size_desc, $default, false); // size_desc
        $this->buildSearchSql($where, $this->color_code, $default, false); // color_code
        $this->buildSearchSql($where, $this->color_desc, $default, false); // color_desc
        $this->buildSearchSql($where, $this->concept, $default, false); // concept
        ...
        $this->buildSearchSql($where, $this->variance_qty, $default, false); // variance_qty
        $this->buildSearchSql($where, $this->confirmation_date, $default, false); // confirmation_date
        $this->buildSearchSql($where, $this->confirmation_time, $default, false); // confirmation_time
        $this->buildSearchSql($where, $this->box_code, $default, false); // box_code
        $this->buildSearchSql($where, $this->box_type, $default, false); // box_type
        ...
        $this->buildSearchSql($where, $this->aisle, $default, false); // aisle
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->to_no->AdvancedSearch->save(); // to_no
            $this->to_order_item->AdvancedSearch->save(); // to_order_item
            $this->to_priority->AdvancedSearch->save(); // to_priority
            $this->to_priority_code->AdvancedSearch->save(); // to_priority_code
            $this->source_storage_type->AdvancedSearch->save(); // source_storage_type
            $this->source_storage_bin->AdvancedSearch->save(); // source_storage_bin
            $this->carton_number->AdvancedSearch->save(); // carton_number
            $this->creation_date->AdvancedSearch->save(); // creation_date
            $this->gr_number->AdvancedSearch->save(); // gr_number
            $this->gr_date->AdvancedSearch->save(); // gr_date
            $this->delivery->AdvancedSearch->save(); // delivery
            ...
            $this->size_code->AdvancedSearch->save(); // size_code
            ...
            $this->variance_qty->AdvancedSearch->save(); // variance_qty
            $this->confirmation_date->AdvancedSearch->save(); // confirmation_date
            $this->confirmation_time->AdvancedSearch->save(); // confirmation_time
            $this->box_code->AdvancedSearch->save(); // box_code
            $this->box_type->AdvancedSearch->save(); // box_type
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->aisle2->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->store_id2->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fpicking_pendinglist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fpicking_pendinglist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("po_no", $this->createColumnOption("po_no"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpicking_pendingsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpicking_pendingsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fpicking_pendinglist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->aisle2->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->aisle2->AdvancedSearch->SearchValue != "" || $this->aisle2->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->store_id2->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->store_id2->AdvancedSearch->SearchValue != "" || $this->store_id2->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->close_totes->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->close_totes->AdvancedSearch->SearchValue != "" || $this->close_totes->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fpicking_pendinglist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fpicking_pendingsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
        ...
        if (IsMobile()) {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"pickingpendingsearch\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        } else {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"picking_pending\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" data-ew-action=\"modal\" data-url=\"pickingpendingsearch\" data-btn=\"SearchBtn\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        }
        $item->Visible = true;
