 ...
 * Page class
 */
class MasterArticle2Delete extends MasterArticle2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterArticle2Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("masterarticle2list"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("masterarticle2list"); // Return to list
                return;
            }
        }
