...
class ChangePassword extends User
{
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("user", "user", "opwd", "opwd", "opwd", "", 202, 255, -1, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-form-control");
        $this->NewPassword = new DbField("user", "user", "npwd", "npwd", "npwd", "", 202, 255, -1, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-form-control");
        $this->ConfirmPassword = new DbField("user", "user", "cpwd", "cpwd", "cpwd", "", 202, 255, -1, false, "", false, false, false);
