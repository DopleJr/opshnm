...
/**
 * Table class for monitor_audit_picking
 */
class MonitorAuditPicking extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'monitor_audit_picking';
        $this->TableName = 'monitor_audit_picking';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`monitor_audit_picking`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`monitor_audit_picking`";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, if(done = total,'OK','Process') AS `status`");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("monitorauditpickinglist");
    }
    ...
    {
        global $Language;
        if ($pageName == "monitorauditpickingview") {
            return $Language->phrase("View");
        } elseif ($pageName == "monitorauditpickingedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "monitorauditpickingadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MonitorAuditPickingView";
            case Config("API_ADD_ACTION"):
                return "MonitorAuditPickingAdd";
            case Config("API_EDIT_ACTION"):
                return "MonitorAuditPickingEdit";
            case Config("API_DELETE_ACTION"):
                return "MonitorAuditPickingDelete";
            case Config("API_LIST_ACTION"):
                return "MonitorAuditPickingList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("monitorauditpickingview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("monitorauditpickingview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "monitorauditpickingadd?" . $this->getUrlParm($parm);
        } else {
            $url = "monitorauditpickingadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("monitorauditpickingedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("monitorauditpickingadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("monitorauditpickingdelete", $this->getUrlParm());
    }
    ...
    public function rowRendered()
    {
        ...
        if ($this->status->ViewValue == "OK"){ 
                $this->status->ViewAttrs["style"] = "
                color: aliceblue;
                background-color: green
                ";}
         elseif ($this->status->ViewValue == "Process") { 
                $this->status->ViewAttrs["style"] = "
                color: aliceblue;
