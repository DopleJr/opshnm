...
/**
 * Table class for admin_permissions
 */
class AdminPermissions extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'admin_permissions';
        $this->TableName = 'admin_permissions';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`admin_permissions`";
        $this->Dbid = 'DB';
        ...
        $this->properties->InputTextType = "text";
        $this->Fields['properties'] = &$this->properties;

        // conditions
        $this->conditions = new DbField(
            'admin_permissions',
            'admin_permissions',
            'x_conditions',
            'conditions',
        ...
        $this->conditions->InputTextType = "text";
        $this->Fields['conditions'] = &$this->conditions;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`admin_permissions`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->properties->DbValue = $row['properties'];
        $this->conditions->DbValue = $row['conditions'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("adminpermissionslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "adminpermissionsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "adminpermissionsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "adminpermissionsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "AdminPermissionsAdd";
            case Config("API_EDIT_ACTION"):
                return "AdminPermissionsEdit";
            case Config("API_DELETE_ACTION"):
                return "AdminPermissionsDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("adminpermissionsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("adminpermissionsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "adminpermissionsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "adminpermissionsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("adminpermissionsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("adminpermissionsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("adminpermissionsdelete", $this->getUrlParm());
    }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->properties->setDbValue($row['properties']);
        $this->conditions->setDbValue($row['conditions']);
    ...
    public function renderListRow()
    {
        ...
        // conditions
        $this->conditions->ViewValue = $this->conditions->CurrentValue;
        $this->conditions->ViewCustomAttributes = "";
        ...
        // conditions
        $this->conditions->LinkCustomAttributes = "";
        $this->conditions->HrefValue = "";
        $this->conditions->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // properties
        $this->properties->setupEditAttributes();
        $this->properties->EditCustomAttributes = "";
        $this->properties->EditValue = $this->properties->CurrentValue;
        $this->properties->PlaceHolder = RemoveHtml($this->properties->caption());

        // conditions
        $this->conditions->setupEditAttributes();
        $this->conditions->EditCustomAttributes = "";
        $this->conditions->EditValue = $this->conditions->CurrentValue;
        $this->conditions->PlaceHolder = RemoveHtml($this->conditions->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->properties);
                    $doc->exportCaption($this->conditions);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->properties);
                        $doc->exportField($this->conditions);
