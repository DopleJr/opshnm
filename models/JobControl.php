...
class JobControl extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->test4->InputTextType = "text";
        $this->Fields['test4'] = &$this->test4;
    ...
    public function renderEditRow()
    {
        ...
        $this->test4->EditValue = $this->test4->CurrentValue;
