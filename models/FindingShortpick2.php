...
/**
 * Table class for finding_shortpick
 */
class FindingShortpick2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'finding_shortpick2';
        $this->TableName = 'finding_shortpick';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`finding_shortpick`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // date_shortpick
        $this->date_shortpick = new DbField(
            'finding_shortpick2',
            'finding_shortpick',
            'x_date_shortpick',
            'date_shortpick',
            '`date_shortpick`',
            CastDateFieldForLike("`date_shortpick`", 0, "DB"),
            133,
            10,
            0,
            false,
        ...
        $this->date_picking = new DbField(
            ...
            'date_picking',
            '`date_picking`',
            CastDateFieldForLike("`date_picking`", 0, "DB"),
            133,
            10,
            0,
            false,
        ...
        // time_picking
        $this->time_picking = new DbField(
            'finding_shortpick2',
            'finding_shortpick',
            'x_time_picking',
            'time_picking',
            '`time_picking`',
            CastDateFieldForLike("`time_picking`", 3, "DB"),
            134,
            10,
            3,
            false,
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`finding_shortpick`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->avaiable->DbValue = $row['avaiable'];
        ...
        $this->date_shortpick->DbValue = $row['date_shortpick'];
        $this->date_upload->DbValue = $row['date_upload'];
        $this->date_picking->DbValue = $row['date_picking'];
        $this->time_picking->DbValue = $row['time_picking'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("findingshortpick2list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "findingshortpick2edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "findingshortpick2add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "FindingShortpick2View";
            case Config("API_ADD_ACTION"):
                return "FindingShortpick2Add";
            case Config("API_EDIT_ACTION"):
                return "FindingShortpick2Edit";
            case Config("API_DELETE_ACTION"):
                return "FindingShortpick2Delete";
            case Config("API_LIST_ACTION"):
                return "FindingShortpick2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("findingshortpick2view", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("findingshortpick2view", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "findingshortpick2add?" . $this->getUrlParm($parm);
        } else {
            $url = "findingshortpick2add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("findingshortpick2edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("findingshortpick2add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("findingshortpick2delete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->avaiable->EditValue = $this->avaiable->CurrentValue;
        ...
        $this->date_shortpick->EditValue = FormatDateTime($this->date_shortpick->CurrentValue, $this->date_shortpick->formatPattern());
        ...
        $this->date_picking->EditValue = FormatDateTime($this->date_picking->CurrentValue, $this->date_picking->formatPattern());
        ...
        $this->time_picking->EditValue = FormatDateTime($this->time_picking->CurrentValue, $this->time_picking->formatPattern());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->avaiable);
                    ...
                    $doc->exportCaption($this->date_shortpick);
                    $doc->exportCaption($this->date_upload);
                    $doc->exportCaption($this->date_picking);
                    $doc->exportCaption($this->time_picking);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->location);
                    $doc->exportCaption($this->ctn);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->date_shortpick);
                        $doc->exportField($this->date_upload);
                        $doc->exportField($this->date_picking);
                        $doc->exportField($this->time_picking);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->location);
                        $doc->exportField($this->ctn);
    ...
    public function rowInserted($rsold, &$rsnew)
    {
        ...
        $_avaiable = $rsnew["avaiable"];
        $_web = $rsnew["web"];
        $_status = "Pending";
        $area = "SELECT `area` FROM `locations` WHERE `location` =  '$_location' ";
        $_area = ExecuteScalar($area);
        $_total = $_avaiable + $_web; 
        $sql4 = "UPDATE finding_shortpick SET `target_quantity` = '$_total',`date_upload` = '$currentDate',`status` = '$_status',`area` = '$_area' WHERE `id` = '$_id' ";
